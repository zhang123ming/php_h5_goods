		...
		public function sendMessage($id = 0)
		{
			...
			if ($log['status'] == 2) {
				if (!empty($type)) {
					...
					if ($log['dispatchstatus'] != 1) {
						...
						$msg = array(
							...
							'keyword2' => array('title' => '消耗'.$_W['shopset']['trade']['credittext'].'', 'value' => $credits, 'color' => '#4a5077'),
							'keyword3' => array('title' => '剩余'.$_W['shopset']['trade']['credittext'].'', 'value' => $credit, 'color' => '#4a5077'),
				...
				if (($log['dispatchstatus'] == 1) || ($log['dispatchstatus'] == -1)) {
					...
					$msg = array(
						'first'    => array('value' => ''.$_W['shopset']['trade']['credittext'].'商城商品兑换成功~', 'color' => '#4a5077'),
				...
				if ($log['status'] == 3) {
					...
					$msg = array(
						'first'    => array('value' => '您的'.$_W['shopset']['trade']['credittext'].'兑换奖品已发货~', 'color' => '#4a5077'),
