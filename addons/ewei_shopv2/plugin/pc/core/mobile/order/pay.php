	...
	public function main() 
	{
		...
		// {
			...
			if (isset($set['pay']) && ($set['pay']['weixin'] == 1) && ($jie !== 1)) 
			{
				...
				// if($_SERVER['REMOTE_ADDR']=='59.42.239.171'){
    //                 var_dump($wechat);die;
    //             }
				// $wechat = array("return_code"=> "SUCCESS","return_msg"=> "OK","appid"=> "wx54669d8a1d4a86e2","mch_id"=> "1501914311","device_info"=>"ewei_shopv2","nonce_str"=>"Af7UumTxUFXdUvZs","sign"=>"D5182D7FCF8DF97C8D25A8B3A034593E","result_code"=>"SUCCESS","prepay_id"=>"wx101020323026324112a6eb661857315900","trade_type"=>"NATIVE","code_url"=>"weixin://wxpay/bizpayurl?pr=tLtpGxz");
				// var_dump($wechat);die;
				if (!(is_error($wechat))) 
				{
					$wechat['success'] = true;
				...
				if(!empty($wechat['code_url'])){
					$filename = $params['tid'];
					$wechat['qrcodeurl'] = m('qrcode')->createQrcode($wechat['code_url'],$filename);
				}
			}
