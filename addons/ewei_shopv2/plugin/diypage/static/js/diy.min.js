define(['jquery.ui'], function (ui) {
    ...
    modal.initNavs = function () {
        modal.getNavs();
        var navgroup = {
            0: ['listmenu', 'richtext', 'title', 'line', 'blank', 'menu', 'menu2', 'picture', 'banner', 'picturew', 'pictures', 'icongroup', 'audio', 'coupon','task2'],
    ...
    modal.getNavs = function () {
        modal.navs = {
            ...
            memberc: {
                ...
                style: {background: '#fe5455', textcolor: '#ffffff', textlight: '#ffffff',fontsize:'12'}
            },
            blockgroup: {
                name: '图标块',
                params: {rownum: 3},
        ...
        if (richtext > 0) {
            ...
            UE.registerUI('mylink', function (editor, uiName) {
                var btn = new UE.ui.Button({
                    ...
                    onclick: function () {
                        $("#" + this.id).attr({"data-toggle": "selectUrl","data-platform":"","data-callback": "selectUrlCallback"})
                    }
                });
                editor.addListener('selectionchange', function () {
                    var state = editor.queryCommandState(uiName);
