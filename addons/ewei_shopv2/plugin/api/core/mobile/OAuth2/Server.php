    ...
    UserInfoControllerInterface
{
    ...
    {
        $this->response = is_null($response) ? new Response() : $response;
        // file_put_contents('s100apirequest.txt', var_export($request,true).date('Ymd H:i:s')."\r\n",FILE_APPEND);
    ...
    protected function createDefaultTokenController()
    {
        ...
        // file_put_contents('s100apigrant.txt', var_export($this->grantTypes,true).date('Ymd H:i:s')."\r\n",FILE_APPEND);
        ...
        // file_put_contents('s100apigrant.txt', var_export($accessTokenResponseType,true).date('Ymd H:i:s')."\r\n",FILE_APPEND);
