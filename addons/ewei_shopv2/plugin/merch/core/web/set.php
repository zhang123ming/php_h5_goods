...
class Set_EweiShopV2Page extends PluginWebPage 
{
	public function main() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			$data['near_distance'] = intval($data['near_distance']);
			...
			$data['regpicKey'] = intval($data['regpicKey']);
		...
		$mobileurl = $_W['siteroot'].'app/index.php?i='.$_W['uniacid'].'&c=entry&m=ewei_shopv2&do=mobile&r=merch.register';
		$qrcodeMobile = m('qrcode')->createQrcode($mobileurl);
		$styles = array();
