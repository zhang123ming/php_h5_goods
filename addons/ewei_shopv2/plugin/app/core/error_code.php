...
class AppError
{
	...
	static 	public $OrderCanNotCreate = 50020;
	...
	static 	public $errCode = array(0 => '处理成功', -1 => '系统内部错误', -2 => '参数错误', -3 => '未登录', -9 => '插件未找到', -6 => '错误的请求', 90000 => '验证码错误', 90001 => '验证码失效', 10000 => '登录失败', 10001 => '登录失效', 10002 => '手机号已存在', 10003 => '用户不存在', 10004 => '用户是黑名单', 10010 => '用户未绑定手机号', 20000 => '商品不存在', 20001 => '商品不存在(1)', 20002 => '不能加入购物车', 20003 => '无购物车记录', 30000 => '地址未找到', 30101 => '系统未开启提现', 30102 => '提现金额错误', 30103 => '提现金额过大', 30104 => '未选择提现方式', 30105 => '请填写姓名', 30106 => '请填写支付宝帐号', 30107 => '请填写确认帐号', 30108 => '支付宝帐号与确认帐号不一致', 30109 => '请选择银行', 30110 => '请填写银行卡号', 30111 => '请填写确认卡号', 30112 => '银行卡号与确认卡号不一致', 40000 => '微信支付未开启', 40001 => '微信支付参数错误', 80000 => '页面不存在', 80001 => '菜单不存在', 81000 => '无权限操作', 81001 => '未开启管理端', 81002 => '退款失败', 81003 => '插件未开启', 91000 => '短信发送失败(SMSidNull)', 91001 => '60秒内只能发送一次', 92000 => '此手机号已与当前账号绑定', 92001 => '此手机号已与其他帐号绑定, 如果继续将会解绑之前帐号', 92002 => '此手机号已通过其他方式注册, 如果继续将会合并账号信息', 92003 => '绑定失败', 92004 => '未开启绑定', 92005 => '绑定确认', 101000 => '未选择文件', 101001 => '上传失败', 50000 => '订单未找到', 50001 => '无物流信息', 50002 => '订单无法取消', 50003 => '订单无法收货', 50004 => '订单无法恢复', 50005 => '订单无法删除', 50006 => '商品出错', 50007 => '最低购买限制', 50008 => '一次最多购买限制', 50009 => '最多购买限制', 50010 => '限时购时间未开始', 50011 => '限时购时间已结束', 50012 => '会员等级限制', 50013 => '会员组限制', 50014 => '库存不足', 50015 => '订单不能支付', 50016 => '没有合适的支付方式', 50017 => '支付出错', 50018 => '订单已经支付', 50019 => '请不要重复提交',50020 => "订单无法创建", 51000 => '订单不能申请退款', 51001 => '订单不能评论', 50201 => '任务活动优惠最多购买限制', 50202 => '任务活动优惠商品不能放入购物车下单', 50203 => '不配送区域', 50204 => '下单失败', 50205 => '未找到套餐', 50206 => '套餐未开始', 50207 => '套餐已结束', 61000 => '优惠券不存在', 61001 => '无法从领券中心领取', 61002 => '未找到优惠券领取记录', 61003 => '优惠券领取失败', 70000 => '跳转到注册页面', 70001 => '需要您完善资料才能继续操作', 70002 => '不要短时间重复下提交', 70003 => '您已经是分销商了', 70004 => '没有开启推广二维码!', 70005 => '未找到分销海报!', 70006 => '海报生成失败', 82024 => '身份验证失败');
