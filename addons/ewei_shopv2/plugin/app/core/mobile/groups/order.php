...
class Order_EweiShopV2Page extends AppMobilePage 
{
	...
	public function details() 
	{
		...
		$sysset = array('shopname'=>$shopname);
		app_json(array( "express" => $express, "goodRefund" => $goodRefund,'sysset'=>$sysset, "order" => $order, "address" => $address, "store" => $stores, "verifytotal" => $verifytotal, "verifynum" => $verifynum, "carrier" => $carrier, "verify" => $verify, "goods" => $goods ));
	}
