define(['jquery.ui', '../../../../static/js/web/goods_selector.js'], function (ui, gSelector) {
    ...
    modal.initNavs = function () {
        modal.setNavs();
        var navgroup = {
            0: ['listmenu', 'richtext', 'title', 'line', 'blank', 'menu', 'menu2', 'picture', 'banner', 'picturew', 'pictures', 'icongroup', 'audio', 'coupon', 'video', 'copyright'],
            2: ['notice', 'goods', 'search', 'fixedsearch'],
            20:['member','notice', 'goods', 'search', 'fixedsearch', 'pictures','icongroup', 'audio', 'copyright', 'video'],
        ...
        if ($("#diy-editor .form-richtext").length > 0 && itemid) {
            ...
            UE.registerUI('mylink', function (editor, uiName) {
                var btn = new UE.ui.Button({
                    ...
                    onclick: function () {
                        $("#" + this.id).attr({"data-toggle": "selectUrl","data-platform":"wxapp", "data-callback": "selectUrlCallback"})
                    }
                });
                editor.addListener('selectionchange', function () {
                    var state = editor.queryCommandState(uiName);
