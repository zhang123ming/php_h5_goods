...
class Op_EweiShopV2Page extends MobileLoginPage
{
	...
	public function cancel()
	{
		...
		if (0 < $order['deductprice']) {
			m('member')->setCredit($order['openid'], 'credit1', $order['deductcredit'], array('0', $_W['shopset']['shop']['name'] . '购物返还抵扣'.$_W['shopset']['trade']['credittext'].' '.$_W['shopset']['trade']['credittext'].': ' . $order['deductcredit'] . ' 抵扣金额: ' . $order['deductprice'] . ' 订单号: ' . $order['ordersn']));
		}
