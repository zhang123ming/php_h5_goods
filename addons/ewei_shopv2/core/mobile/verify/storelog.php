...
class Storelog_EweiShopV2Page extends MobileLoginPage
{
	...
	public function main()
	{
		...
		include $this->template('verify/verifyorder/storelog');
	}
	...
	public function get_list()
	{
		...
		$condition = ' and ismr=0 and deleted=0 and uniacid=:uniacid and istrade=0 ';
		...
		unset($row);
		show_json(1, array('list' => $list, 'pagesize' => $psize, 'total' => $total,'storeid'=>$_GPC['storeid']));
	}
	...
	public function detail()
	{
		...
		include $this->template('order/store_order_detail');
	}
	protected function opData($id)
	{
		global $_W;
		global $_GPC;
		// $id = intval($_GPC['id']);
