...
class Recharge_EweiShopV2Page extends MobileLoginPage
{
	public function main()
	{
		...
		if (!empty($_GPC['module'])){
			$_SESSION['paymodule'] =trim($_GPC['module']);
		}
		if (!empty($_GPC['moduleuserid'])){
			$_SESSION['paymoduleuserid'] =intval($_GPC['moduleuserid']);
		}
	...
	public function submit()
	{
		...
		if (!empty($_SESSION['paymodule'])){
			$log['module']=trim($_SESSION['paymodule']);
			unset($_SESSION['paymodule']);
		}
		if (!empty($_SESSION['paymoduleuserid'])){
			$log['moduleuserid']=intval($_SESSION['paymoduleuserid']);
			unset($_SESSION['paymoduleuserid']);
		}
