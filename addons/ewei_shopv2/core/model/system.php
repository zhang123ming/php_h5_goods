...
class System_EweiShopV2Model
{
	...
	public function getMenu($full = false)
	{
		...
		if ($this->merch) {
			...
			if(!$this->is_member){
				unset($allmenus['member']);
			}
			if ($_W['uniacid']!=194) {
				unset($allmenus['order']['items'][6]);
			}
		}
		else {
	...
	protected function shopMenu()
	{
		...
		'goods'      => array(
			...
			'items'    => array(
				...
				array('title' => '全部商品','route' => 'index',  'desc' => '全部商品管理', 'extend' => 'goods.main', 'perm' => 'goods.index'),
		...
		'member'     => array(
			...
			'items'    => array(
				...
				// array('title' => '排行榜设置', 'route' => 'rank', 'desc' => '会员'.$_W['shopset']['trade']['credittext'].'/消费排行榜设置'),
				array('title' => '代理审核', 'route' => 'agent'),
				array('title' => '分公司', 'route' => 'branch'),
				array('title' => '会员下线', 'route' => 'superioragent'),
				// array(
				// 	'title'   => '微信会员卡',
				// 	'route'   => 'card',
				// 	//'iscom'   => 'card',
				...
				// 	),
				// array('title'=>'会员信息导入','route'=>'import')
				)
			),
		'order'      => array(
			'title'    => '订单',
			...
			'items'    => array(
				...
				array('title' => '预付订单', 'route' => 'list.prepay', 'desc' => '已关闭订单管理'),
				array('title' => '全部订单', 'route' => 'list', 'desc' => '全部订单列表', 'permmust' => 'order.list.main'),
				array('title'=>'租用记录','route'=>'rent','desc'=>'租用记录'),
				array(
					'title' => '维权',
					'route' => 'list',
					'items' => array(
				...
				array(
					...
					'items' => array(
						...
						array('title' => '导入支付记录', 'route' => 'importPayments', 'desc' => '导入支付记录')
						)
					)
				)
			),
			...
			'items'    => array(
				array(
					...
					'items' => array(
						...
						// array('title' => ''.$_W['shopset']['trade']['credittext'].'优惠', 'route' => 'credit1', 'desc' => ''.$_W['shopset']['trade']['credittext'].'优惠设置', 'keywords' => '营销'),
						...
						// array('title' => '生日优惠', 'route' => 'birthday', 'keywords' => '生日优惠'),
						// array('title' => '弹幕管理', 'route' => 'danmu', 'keywords' => '弹幕管理')
						)
				...
				array(
					...
					'items' => array(
						...
						// array('title' => '批量导入', 'route' => 'import', 'desc' => '批量导入优惠券码')
						)
					),
				// array(
				// 	'title' => '微信卡券',
		...
		'finance'    => array(
			...
			'icon'     => '31',
			'items'    => array(
			    array('title' => '代理佣金', 'route' => 'agentcommission'),
				array(
					'title' => '财务',
					'route' => 'log',
					'items' => array(
						...
						array('title' => '转账审核', 'route' => 'collect')
						)
					),
				array(
					'title' => '明细',
					'route' => 'credit',
					'items' => array(
						array('title' => ''.$_W['shopset']['trade']['credittext'].'明细', 'route' => 'credit1'),
						array('title' => '余额明细', 'route' => 'credit2'),
						// array('title' => '<span style="display: inline-block;line-height: 20px;">余额明细<br>(小程序)</span>', 'route' => 'wxapp'),
						array('title' => '佣金明细', 'route' => 'otherrecord')
						)
					),
				array(
					'title' => '发票',
					'route' => 'invoice',
					'items' => array(
						array('title' => '发票记录', 'route' => 'invoice'),
						array('title' => '发票设置', 'route' => 'setinvoice')
						)
					),
				array(
					'title' => '对账单',
		...
		'statistics' => array(
			...
			'icon'     => 'statistics',
			'items'    => array(
			    array('title' => '分享统计', 'route' => 'sharecount'),
				array(
					'title' => '销售统计',
					'items' => array(
				...
				array(
					...
					'items' => array(
						...
						array('title' => '在售商品','route' => 'goods_insale')
						)
					),
				array(
					'title' => '会员统计',
				...
				array(
					'title' => '搜索统计',
					'items' => array(
						array('title' => '搜索词统计', 'route' => 'search_keywords'),
						)
					),
				)
			),
	...
	'perm' => array(
		...
		'items'    => array(
			...
			array('title' => '员工考勤', 'route' => 'attendance'),
