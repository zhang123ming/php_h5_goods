			...
			if (is_array($_GPC['shop'])) {
				foreach ($_GPC['shop'] as $data) {
					if ($data == 'goods') {
						...
						pdo_query('delete from   ' . tablename('mc_members') . ' where 1 ' . $condition);
						pdo_query('delete from   ' . tablename('mc_mapping_fans') . ' where 1 ' . $condition);
						pdo_query('delete from   ' . tablename('mc_credit_record') . ' where 1 ' . $condition);
						pdo_query('delete from   ' . tablename('ewei_shop_commission_record') . ' where 1 ' . $condition);
					}
					else if ($data == 'order') {
