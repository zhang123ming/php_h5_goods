						...
						if ($d['backtype'] == 0) {
							...
							if ($d['backtype'] == 2) {
								if (!empty($d['backmoney']) && (0 < $d['backmoney'])) {
									...
									if (!empty($d['backcredit']) && (0 < $d['backcredit'])) {
										$d['value_text'] = ''.$_W['shopset']['trade']['credittext'].'';
