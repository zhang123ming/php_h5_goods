...
class Perm_EweiShopV2ComModel extends ComModel
{
	...
	protected function perm_pc()
	{
		return $this->isopen('pc') && $this->is_perm_plugin('pc') ? array(
	'text'     => m('plugin')->getName('pc'),
	'shop'   => array('text' => '站点设置','main' => '编辑-log'),
	'link' => array('text' => '友情链接', 'main' => '查看列表', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
	'menu' => array('text' => '菜单管理', 'main' => '查看列表', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
	'slide'    => array('text' => '首页轮播', 'main' => '查看列表', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
	'recommend'  => array('text' => '精品推荐', 'main' => '查看列表','add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
	'adv'     => array('text' => '广告管理', 'main' => '查看列表','add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log')
	) : array();
	}
	...
	'agent'    => array('text' => '代理审核', 'main' => '查看列表', 'edit' => '修改', 'delete' => '删除'),
	'branch'    => array('text' => '分公司', 'main' => '查看列表 ','add' => '添加-log', 'edit' => '修改-log'),
	'superioragent'    => array('text' => '会员下线', 'main' => '查看列表 ', 'edit' => '修改-log'),
	...
	protected function perm_finance()
	{
		return array(
	'text'         => '财务管理',
	'log'          => array('text' => '财务管理', 'recharge' => '充值记录', 'withdraw' => '提现申请','collect'=>'转账审核','refund' => '充值退款-log', 'alipay' => '支付宝提现-log', 'wechat' => '微信提现-log', 'manual' => '手动提现-log', 'refuse' => '拒绝提现-log', 'recharge.export' => '充值记录导出-log', 'withdraw.export' => '提现申请导出-log'),
	'downloadbill' => array('text' => '对账单', 'main' => '下载-log'),
	'recharge'     => array('text' => '充值', 'credit1' => '充值积分-log', 'credit2' => '充值余额-log'),
	'credit'       => array('text' => '积分余额明细', 'credit1' => '积分明细', 'credit1.export' => '导出积分明细', 'credit2' => '余额明细', 'credit2.export' => '导出余额明细','otherrecord' => '佣金明细'),
	'agentcommission'    => array('text' => '代理佣金', 'main' => '代理佣金 ','edit' => '打款'),
	);
	}
	...
	'goods_insale'	  => array('text' => '在售商品', 'main' => '查看', 'export' => '导出-log'),
	'search_keywords'=> array('text' => '搜索统计', 'main' => '查看', 'export' => '导出-log'),
	);
	}
	...
	'delete'   => '删除-log',
	// 'record'   => '查看统计',
	'record' => array('text' => '统计管理', 'main' => '查看统计', 'export' => '导出-log'),
	...
	protected function perm_groupaward()
	{
		return $this->isopen('groupaward') && $this->is_perm_plugin('groupaward') ? array(
		'text'   => m('plugin')->getName('groupaward'),
		'agent'  => array(
			'text'   => '团队管理',
			'main'   => '查看列表',
			// 'edit'   => '修改-log',
			// 'delete' => '删除-log',
			// 'export'=>'会员导出',
			// 'xxx'    => array('check' => 'edit','post'=>'edit')
			),
		'bonus'  => array(
			'text'          => '结算管理',
			'build'			=>'创建结算单',
	...
	protected function perm_machine()
	{
		return $this->isopen('machine') && $this->is_perm_plugin('machine') ? array(
		'text'   => m('plugin')->getName('machine'),
		'agent'  => array(
			'text'   => '粉丝管理',
			'main'   => '查看列表',
			'edit'   => '修改-log',
			'delete' => '删除-log',
			'changemachineid'=>'更改机器编码',
			'export'=>'会员导出',
			'xxx'    => array('check' => 'edit','post'=>'edit')
			),
		'machine'  => array('text' => '机器管理', 'main' => '查看机器列表', 'add' => '添加机器-log', 'edit' => '修改机器-log', 'delete' => '机器删除-log','sendlist'=>'发货查看','send'=>'发货','deldelivery'=>'发货删除','export'=>'发货单导出',
			'xxx'    => array('check' => 'edit','checkin'=>'edit')
	),
		'level'  => array('text' => '创客等级管理', 'main' => '查看列表', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'
	),
		'order'  => array('text' => '流水管理', 'main' => '查看支付流水','mrecord'=>'查看业绩流水', 'log' => '查看奖金详情','balance'=>'差额详情'
	),
		'bonus'  => array(
			'text'          => '结算管理',
			'status0'       => '待审核管理',
	...
	protected function perm_bottledoctor()
	{
		return $this->isopen('bottledoctor') && $this->is_perm_plugin('bottledoctor') ? array(
	'text'     => m('plugin')->getName('bottledoctor'),
	...
	'user'       => array('text' => '商户管理', 'view' => '查看详情', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log','status'=>'修改状态-log'),
	...
	public function perm_ticket()
	{
		return $this->isopen('cashier') && $this->is_perm_plugin('cashier') ? array(
		'text'     => m('plugin')->getName('ticket'),
		'index'     => array(
			'text' => '用户小票',
			'main'   => '查看列表',
			'check'    => '审核-log',
		...
		'log'      => array('text' => '操作记录', 'view' => '查看', 'edit' => '编辑-log'),
		) : array();
	}
