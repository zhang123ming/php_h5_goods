define(['core', 'tpl', 'biz/goods/cart', 'biz/plugin/diyform'], function(core, tpl, cart, diyform) {
    var modal = {
        goodsid: 0,
        goods: [],
        option: false,
        ...
        if (modal.goodsid != params.goodsid) {
            ...
            core.json('goods/picker', obj, function(ret) {
                ...
                if(ret.result.canbuy==0){
                    modal.canbuy = ret.result.canbuy;
