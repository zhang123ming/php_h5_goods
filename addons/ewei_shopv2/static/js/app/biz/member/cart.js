define(['core', 'tpl', 'biz/goods/picker', 'biz/plugin/diyform'], function (core, tpl, picker, diyform) {
    ...
    modal.bindEvents = function () {
        ...
        $('.btn-finish').unbind('click').click(function () {
            modal.caculate();
            modal.changeMode();
        });
    ...
    modal.caculateEdit = function () {
        ...
        if (selects > 0) {
            $('.btn-delete').removeClass('disabled btn-default').addClass('btn-danger-o');
            $('.btn-favorite').removeClass('disabled btn-default').addClass('btn-danger');
        } else {
            $('.btn-delete').addClass('disabled btn-default').removeClass('btn-danger-o');;
            $('.btn-favorite').addClass('disabled btn-default').removeClass('btn-danger');
        }
    };
