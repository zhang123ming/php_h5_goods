...
function _tpl_form_field_date($name, $value = '', $withtime = false) {
	...
	$s .= '<input type="text" style="background-color:#fff;" name="' . $name . '"  value="'.$value.'" placeholder="请选择日期时间" readonly="readonly" class="datetimepicker form-control" style="padding-left:12px;" />';
	$s .= '
	...
	<div class="input-group">
		...
		<span class="input-group-btn">
			...
			<ul class="dropdown-menu">
				<li><a href="javascript:" data-type="article" onclick="articleLinkDialog(this)">活动链接</a></li>
				<li><a href="javascript:" data-type="news" onclick="newsLinkDialog(this)">会员链接</a></li>
			</ul>
		</span>
	</div>
	';
