    ...
    var d = {
        ...
        initAudioUploader: function() {
            ...
            var q = {
                ...
                paste: "#uploader",
                swf: "./resource/componets/webuploader/Uploader.swf",
                server: "./index.php?i="+i.options.acid+"&c=utility&a=file&do=upload&type=audio",
                chunked: !1,
                compress: !1,
                accept: {
                    title: "Audios",
