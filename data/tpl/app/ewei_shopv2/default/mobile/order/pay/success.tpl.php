...
<div class='fui-page order-success-page pay'>
	...
	<div class='fui-list-group result-list ' style="margin-top: 0;">
		...
		<div class='fui-list-media' >
			...
			<img src="/addons/ewei_shopv2/static/images/order/status-success.png" alt="">
		...
		<div class="fui-list-angle">
				...
				￥<?php  if(empty($peerprice)) { ?><?php  echo number_format($order['price'],2)?><?php  } else { ?><?php  echo $peerprice['price'];?><?php  } ?>
	...
	<div class='fui-list-group' style='margin-top:0px;'>
	        <?php  if(!empty($carrier)) { ?>
	    <div class='fui-list' style=" flex-direction: row; padding: .5rem .5rem; ">
	...
	<!-- <div class="fui-cell-group small">
	    <div class="fui-cell">
		...
		<?php  if(!empty($order['virtual']) && !empty($order['virtual_str']) && $_GPC['result']!='seckill_refund') { ?>
		<!--发货信息-->
		<div class="fui-according-group">
	...
	<div class='row'>
			<div class='col-50'>
					<?php  if($order['isnewstore']==1) { ?>
						<a class="btn btn-danger-o external" href="<?php  echo mobileUrl('newstore.stores.detail',array('storeid'=>$order['storeid']))?>" >返回门店</a>
					<?php  } else { ?>
						<a class="btn btn-danger-o external" href="<?php  echo mobileUrl()?>" >返回首页</a>
					<?php  } ?>
				</div>
	    <div class='col-50'>
		<a class="btn btn-danger external" <?php  if(empty($ispeerpay)) { ?>href="<?php  echo mobileUrl('order/detail',array('id'=>$order['id']))?>"<?php  } else { ?>href="<?php  echo mobileUrl('order/pay/peerpaydetail',array('id'=>$orderid))?>"<?php  } ?> >订单详情</a>
	    </div>
	...
	<div class="fui-goods-group block">
			<?php  if(is_array($likeGoods)) { foreach($likeGoods as $item) { ?>
				<a class="fui-goods-item" data-goodsid=""
				href="<?php  echo mobileUrl('goods/detail',array('id'=>$item['id']),true)?>"
				data-nocache="true">
					<div class="image   triangle" style='background-image: url("<?php  echo tomedia($item['thumb']);?>");'data-lazyloaded="true">
					</div>
					<div class="detail">
						<div class="name">
							<?php  echo $item['title'];?>
						...
						<div class="price">
							...
							<span class="text">
								<p class="minprice">¥<?php  echo $item['minprice'];?></p>
							</span>
						</div>
					</div>
					<div class="salez"></div>
			...
			<?php  } } ?>	
		<!-- <a class="fui-goods-item" data-goodsid=""
		href="./index.php?i=4&amp;c=entry&amp;m=ewei_shopv2&amp;do=mobile&amp;r=goods.detail&amp;id="
		data-nocache="true">
		<div class="image   triangle" style='background-image: url("http://img2.y01.cn/images/266/2019/05/EDVT6a6mqz6U6uVdAQT6iTXMVrID1i.jpg");'data-lazyloaded="true">
		</div>
		<div class="detail">
			<div class="name">
				这里是商品标题
