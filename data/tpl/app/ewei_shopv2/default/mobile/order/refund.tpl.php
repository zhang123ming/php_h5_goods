...
<div class='fui-page page-refund-edit <?php  if(empty($order['refundstate'])) { ?>fui-page-current<?php  } ?>' id='page-refund-edit' >
...
<div class='fui-content navbar'>
    <div class="bg-gray">
        ...
        <!-- <div class="fui-cell-group goods-cell-group">
            <div class="fui-cell">
                    <div class="fui-cell-info">共4件商品</div>
                    <div class="fui-cell-remark show-goods">展开全部 </div>
            </div>
                ...
                <div class="fui-list-group goods-list-group">
                    <div class="fui-list goods-list">
                        <div class="fui-list-media" style="">
                            <img class="round" src="http://img2.y01.cn/images/266/merch/377/KcxG4P1CT5lZgtMA2GXI4Pszl0Y5XX.png?t=i22Xi75Fq2KPaK7mJOVis2K2Vss5K7mMo8pAkkVpKl0Q17PI5m" data-lazyloaded="true">
                        </div>
                        <div class="fui-list-inner">
                            <div class="text goodstitle towline">dasdas</div>

                            <div class="subtitle" style="color:#999;">啊沙发沙发</div>

                            <div class="goodsprice">
                                <span class="marketprice">￥12121.00</span>
                                <span >x1</span>
                            </div>
                        </div>
                    ...
                    <div class="show-goods-content first-line">
                        <div class="fui-list goods-list">
                                <div class="fui-list-media" style="">
                                    <img class="round" src="http://img2.y01.cn/images/266/merch/377/KcxG4P1CT5lZgtMA2GXI4Pszl0Y5XX.png?t=i22Xi75Fq2KPaK7mJOVis2K2Vss5K7mMo8pAkkVpKl0Q17PI5m" data-lazyloaded="true">
                                </div>
        ...
        <div class="fui-cell-group">
            ...
            <div class="fui-cell before0 r-group" <?php  if($refund['rtype']=='2') { ?>style="display:none;"<?php  } ?>>
            <div class="fui-cell-label">退款金额</div>
            <div class="fui-cell-info">
                <input type="number" id="price" class='fui-input' placeholder="请输入需要退的金额" value="<?php  if(!empty($refund['id'])) { ?><?php  echo $show_price?><?php  } ?>" />
            </div>
    ...
    <div class='fui-cell r-group'  <?php  if($refund['rtype']=='2') { ?>style="display:none;"<?php  } ?>>
        <div class="fui-cell-info">
            <span style="color: #E4454E;">*</span>温馨提示：您可退款的最大金额为 <span class='text-danger'>￥<?php  echo number_format($order['refundprice'],2)?></span>
            </div>
        ...
        <div class="fui-cell-group proof-group">
                ...
                <div class="fui-cell">
                    ...
                    <div class="fui-cell-info">
                        ...
                        <ul class="fui-images " id="images">
    
                            <?php  if(is_array($refund['imgs'])) { foreach($refund['imgs'] as $k => $v) { ?>
                            <input type="hidden" name="images[]" value="<?php  echo $v;?>" />
                            <li style="background-image:url(<?php  echo tomedia($v)?>)" class="image " data-filename="<?php  echo $v;?>"><span class="image-remove"><i class="icon icon-roundclose"></i></span></li>
                            <?php  } } ?>
    
    
                        </ul>
                        <div class="fui-uploader  refund-container-uploader" style="    border: 1px dashed #D9D9D9;" <?php  if(count($refund['imgs'])==5) { ?>style='display:none'<?php  } ?>
                        data-name="images[]"
                        data-max="5"
...
<div class='fui-page page-refund-info <?php  if(!empty($order['refundstate'])) { ?>fui-page-current<?php  } ?>' id='page-refund-info'>
<div class="fui-header">
    <div class="fui-header-left">
        <a class="back" onclick='history.back()'></a>
    </div>
