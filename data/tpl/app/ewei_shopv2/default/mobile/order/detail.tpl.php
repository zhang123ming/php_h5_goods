...
<style>
    ...
    /* .fui-list:first-child:before{display: block;left: 0; right: 0;} */
...
<div class='fui-page order-detail-page'>
    ...
    <div class='fui-content navbar'>
        ...
        <div class='fui-list-group result-list'>
            <div class='fui-list order-status'>
                ...
                <div class='fui-list-inner'>
                    ...
                    <!-- <div class='text'>订单金额<?php  if(empty($order['isnewstore'])) { ?>(含<?php  echo $courier;?>)<?php  } ?>: &yen; <?php  echo $order['price'];?><span></div> -->
                </div>
                <div class='fui-list-media'>
                    ...
                    <?php  } else { ?>
                    <img style="width: 5rem;height:auto;" src="/addons/ewei_shopv2/static/images/order/status-dfk.png" alt="">
                    <?php  } ?>
                    <?php  } else if($order['status']==1) { ?>
                    <?php  if($order['refundstate'] > 0) { ?>
                    <img style="width: 5rem;height:auto;" src="/addons/ewei_shopv2/static/images/order/status-tk.png" alt="">
                    <?php  } else { ?>
                    ...
                    <?php  } else if($order['status']==2) { ?>
                    <!-- <i class='icon icon-deliver'></i> -->
                    <img style="width: 5rem;height:auto;" src="/addons/ewei_shopv2/static/images/order/status-yfh.png" alt="">

                    <!-- <img style="width: 5rem;height:auto;" src="/addons/ewei_shopv2/static/images/order/status-dfk.png" alt="">
                    <img style="width: 5rem;height:auto;" src="/addons/ewei_shopv2/static/images/order/status-gb.png" alt="">
                    <img style="width: 5rem;height:auto;" src="/addons/ewei_shopv2/static/images/order/status-dpl.png" alt=""> -->



                    <?php  } else if($order['status']==3) { ?>
                    <!-- <img style="width: 5rem;height:auto;" src="/addons/ewei_shopv2/static/images/order/status-finish.png" alt=""> -->
                    <img style="width: 5rem;height:auto;" src="/addons/ewei_shopv2/static/images/order/status-success.png" alt="">
                    <?php  } else if($order['status']==-1) { ?>
        ...
        <div class="QRcode order-verify" data-orderid="<?php  echo $order['id'];?>" data-verifytype="<?php  echo $order['verifytype'];?>" >
            <img src="<?php  echo $qrcodeimg;?>" alt="">
            <div>
                <span>核销码:<?php  echo $verifycode;?></span>
            </div>
        </div>
        <?php  } ?>
        <?php  if($order['remarksaler']) { ?>
        <div class='fui-list-group' style='margin-top:5px;'>
            <div class='fui-list'>
                <div class='fui-list-media'><i class='icon icon-shop'></i></div>
                <div class='fui-list-inner'>
                    <div class='text'>备注：<?php  echo $order['remarksaler'];?></div>
                </div>
            </div>
        </div>
        <?php  } ?>
        <?php  if(!empty($address)) { ?>
        <div class='fui-list-group add-express' style='margin-top:5px;'>
        <?php  if($order['express']!='no') { ?>
            <?php  if(!empty($order['isnewstore'])) { ?>
                <?php  if(!empty($order['expresssn'])) { ?>
                <div class='fui-list'>
                    <div class='fui-list-media'><i class='icon icon-deliver'></i></div>
                    <div class='fui-list-inner'>
                        <div class='text'><span>快递信息:<?php  echo $order['expresssn'];?></span></div>
                    </div>
            ...
            <?php  } else { ?>
                ...
                <a href="<?php  echo mobileUrl('order/express',array('id'=>$order['id']))?>">
                    <div class='fui-list express-item'>
                        <div class='fui-list-media'>
                        <img style=" width: .95rem; height: auto; " src="/addons/ewei_shopv2/static/images/order/d-express.png" alt="">
                        ...
                        <div class='fui-list-inner'>
                            ...
                            <?php  } else { ?>
                            <div class='text'><span ><?php  echo $express['step'];?></span></div>
                            <div class='text'><span ><?php  echo $express['time'];?></span></div>
                            <?php  } ?>
                        </div>
                        <div class='angle'></div>
                    </div>
        ...
        <?php  } ?>
            ...
            <div class='fui-list'>
                <div class='fui-list-media'>
                        <img style=" width: .95rem; height: auto; " src="/addons/ewei_shopv2/static/images/d-address.png" alt="">
            ...
            <?php  if(is_array($goods)) { foreach($goods as $g) { ?>
                ...
                <div class="fui-list goods-list">
                    <div class="fui-list-media" <?php  if($g['status']==2) { ?>style="padding-left:0.5rem;"<?php  } ?>>
                        <a href="<?php  if(empty($order['isnewstore'])) { ?><?php  echo mobileUrl('goods/detail',array('id'=>$g['goodsid']))?><?php  } else { ?><?php  echo mobileUrl('newstore/goods/detail',array('id'=>$g['goodsid'],'storeid'=>$order['storeid']))?><?php  } ?>">
                ...
                <div class="fui-list-inner">
                    ...
                    <div class='goodsprice'>
                             <span class='marketprice'>&yen;<?php  echo round($g['price']/$g['total'],2)?></span>
                        <span>x<?php  echo $g['total'];?></span>
        ...
        <div class="fui-list">
                <div class='fui-cell-group price-cell-group'>
                        ...
                        <?php  if(empty($order['isnewstore'])) { ?>
                        <div class="fui-cell">
                            <div class="fui-cell-label"><?php  echo $courier;?></div>
                            <div class="fui-cell-info"></div>
                            <div class="fui-cell-remark noremark">&yen; <?php  echo $order['dispatchprice'];?></div>
                        </div>
                        <?php  } ?>
                        <?php  if(!empty($order['invoiceprice'])) { ?>
                        <div class="fui-cell">
                            <div class="fui-cell-label">发票</div>
                            <div class="fui-cell-info"></div>
                            <div class="fui-cell-remark noremark">&yen; <?php  echo $order['invoiceprice'];?></div>
                        </div>
                        <?php  } ?>
                        ...
                        <?php  } ?>
                        <div class="fui-cell">
                            <div class="fui-cell-label" style='width:auto;'>实付费<?php  if(empty($order['isnewstore'])) { ?>(含<?php  echo $courier;?>)<?php  } ?></div>
                            <div class="fui-cell-info"></div>
                ...
                <div class="fui-cell" id="fullbackgoods" style="padding:0.5rem 0.3rem;<?php  if($g['fullbackgoods']['minallfullbackallprice']<=0 && $g['fullbackgoods']['minallfullbackallratio']<=0) { ?>display: none;<?php  } ?>">
                    ...
                    <div class="fui-cell-info" style="text-align: right;">
                        <span class="fui-cell-remark noremark" style="font-size: 0.6rem;color:#333;">
                            ...
                            <?php  } else { ?>
                            全返 <?php  if($g['fullbackgoods']['credit']==1) { ?>积分<?php  } else { ?>&yen;<?php  } ?><?php  echo price_format($g['fullbackgoods']['minallfullbackallprice'],2)?>，<?php  if($g['fullbackgoods']['credit']==1) { ?>积分<?php  } else { ?>&yen;<?php  } ?><?php  echo price_format($g['fullbackgoods']['fullbackprice'],2)?>/天，共 <?php  echo $g['fullbackgoods']['day'];?> 天
                            <?php  } ?>
                        </span>
                    </div>
    ...
    <div class="fui-cell-group info-cell-group">
        <div class="fui-cell-title last-line">
                订单信息
        </div>
        <?php  if(!empty($order['ccard'])) { ?>
        <?php  if(is_array($goods)) { foreach($goods as $g) { ?>
        ...
        <?php  } ?>
        <?php  if($order['server_status']==1) { ?>
        <div class="fui-cell">
            <div class="fui-cell-label">服务人: </div>
            <div class="fui-cell-info"><?php  echo $order['server_name'];?></div>
        </div>
        <div class="fui-cell">
            <div class="fui-cell-label">服务时间: </div>
            <div class="fui-cell-info"><?php  echo date('Y-m-d H:i:s', $order['server_time'])?></div>
        </div>
        <?php  } ?>
    </div>
...
<div class='fui-footer'>
    <?php  if($order['userdeleted']==0) { ?>
        ...
        <?php  } ?>
        <?php  if($order['server_status']!=1&&$order['status']!=-1&&$order['status']!=0) { ?>
        <?php (!empty($this) && $this instanceof WeModuleSite) ? (include $this->template('order/server', TEMPLATE_INCLUDEPATH)) : (include template('order/server', TEMPLATE_INCLUDEPATH));?>
        <?php  } ?>
		...
		<?php  if(!empty($activity)&& empty($order['refundstate']) &&$order['status']>0) { ?>
			<?php  if($order['isshare'] == 0) { ?>
				<a data-nocache="true" class="btn btn-default btn-default-o" href="<?php  echo mobileUrl('sale/sendticket/share/unclaimed',array('orderid'=>$order['id'],'money'=>$order['price']))?>">领取优惠券</a>
			<?php  } ?>
		<?php  } ?>
        ...
        <?php  if(empty($commissionSet['commissionsettletype'])) { ?>
