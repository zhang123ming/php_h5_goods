...
<div class='fui-page  fui-page-current page-goods-list'>
    ...
    <div class="fui-content navbar" style="padding-bottom:0px;">
	<div class='fui-content-inner' style="padding-bottom:0px;">
	    <div class='content-empty' style='display:none;'>
		<i class='icon icon-searchlist'></i><br/>暂时没有任何商品
	    </div>
	    <div class="fui-goods-group container block" id="goods-list-container" style="padding: 0 0.2rem;"></div>
...
<script type='text/html' id='tpl_goods_list'>
	 ...
	 <div class="fui-goods-item" data-goodsid="<%g.id%>" data-type="<%g.type%>">
	  ...
	  <div class="image" data-lazy-background="<%g.thumb%>">
		  <%if g.total<=0%><div class="image" style="background-image: url('<?php  echo tomedia($_W['shopset']['shop']['saleout'])?>'); "></div><%/if%>
	  </div>
        </a>
	<div class="detail">
	   	<a style="color:#262626;" <%if g.bargain>0%>href="<?php  echo mobileUrl('bargain/detail')?>&id=<%g.bargain%>"<%else%>href="<?php  echo mobileUrl('goods/detail')?>&id=<%g.id%>"<%/if%>>
