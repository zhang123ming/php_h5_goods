...
<div class='fui-page  fui-page-current member-log-page'>
    ...
    <div class='fui-content navbar' >
        ...
        <div id="tab" class="fui-tab fui-tab-danger">
            <a data-tab="tab1"  class="external <?php  if($_GPC['type']==0) { ?>active<?php  } ?>" data-type='0'>明细记录</a>
        ...
        <div class='content-empty' style='display:none;'>
            <img src="<?php echo EWEI_SHOPV2_STATIC;?>images/norecord.png" style="width: 6rem;" alt=""><br/><br/>暂时没有任何记录!
        </div>
    ...
    <script id="tpl_member_log_list" type="text/html">
        ...
        <div class="fui-list goods-item">
            ...
            <div class="fui-list-inner">
                ...
                <div class='text'><%log.title%></div>
                <%else%>
                <div class='title'>  <%log.remark%>
                </div>
                <div class='text'> </div>
                <div class='text'><%log.createtime%></div>
                <div class='text'>金额：<%log.num%></div>
                <%/if%>
            </div>
