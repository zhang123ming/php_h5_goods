...
<div class='fui-page  fui-page-current fui-page-address' id="page-address-selector">
		...
		<div class="fui-list-inner">
		    <div class="title">
				...
				<div>
						...
						<span class='default' style="<?php  if(!$address['isdefault']) { ?>display: none;<?php  } ?>">默认</span>
    ...
    <div class='btn-fixed'>
	<a href="<?php  echo mobileUrl('member/address/post')?>" class='btn  btn-danger external block' data-nocache="true">
