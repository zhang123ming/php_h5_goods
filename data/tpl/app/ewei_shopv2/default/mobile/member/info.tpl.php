	...
	<div class='fui-content'>
		...
		<div class="fui-cell-group">
			...
			<div class="fui-cell">
				...
				<div class="fui-cell-info"><input type="text"  class='fui-input'  id='city' name='city' placeholder="请选择城市"  value="<?php  if(!empty($show_data) && !empty($member) && !empty($member['city'])) { ?><?php  echo $member['province'];?> <?php  echo $member['city'];?> <?php  echo $member['area'];?><?php  } ?>" data-value="<?php  if(!empty($show_data)) { ?><?php  echo $member['datavalue'];?><?php  } ?>" readonly/></div>
			</div>
		...
		<?php  } ?>
		<a href='#' id='btn-submit'  style="margin-top: 20px;" class='btn btn-success block'>确认修改</a>
	</div>
