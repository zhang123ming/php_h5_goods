...
<div class="fui-page fui-page-current page-commission-index ">
	...
	<div class="headinfo">
			...
			<div class='fui-list'>
				...
				<div class='title'><?php  echo $member['nickname'];?> </div>
					<div class='text' ><?php  echo $this->set['texts']['up']?>: <?php  if(empty($up)) { ?>
						总店
						<?php  } else { ?>
						<?php  echo $up['nickname'];?><?php  if($up['mobile']) { ?>/ <?php  echo $up['mobile'];?><?php  } ?>
						<?php  } ?>
						<br>
					</div>
		...
		<div class="fui-cell-group">
          <a class="fui-cell" href="<?php  echo mobileUrl('commission/qrcode')?>">
		...
		<div class="userblock">
			<div class="line total new">
				<div class="num"><?php  echo number_format($member['applypay'],2)?></div>
			...
			<div class="line usable new">
				...
				<?php  if($cansettle) { ?>
				<a  style="color:#fff;background-color:#FEA23F;" class="btn btn-warning external" href="<?php  echo mobileUrl('commission/withdraw2')?>"><span style="line-height: 1;color:#fff;"><?php  echo $this->set['texts']['commission']?><?php  echo $this->set['texts']['withdraw']?></span></a>
				<?php  } else { ?>
				<div style="color:#fff;background-color:#FEA23F;" class="btn btn-warning disabled" onclick="FoxUI.toast.show('满 <?php  echo $this->set['withdraw']?> <?php  echo $this->set['texts']['yuan']?>才能提现!')"><?php  echo $this->set['texts']['commission']?><?php  echo $this->set['texts']['withdraw']?></div>
				<?php  } ?>
			</div>
		</div>
	<div class="fui-block-group new col-2" style='overflow: hidden;'>
            <a style="border-bottom: 1px solid #ebebeb;" class="fui-block-child new  external" href="<?php  echo mobileUrl('commission/cashbe')?>">
                <div class="icon " style="color: #ff4357;"><i class="icon icon-qian"></i></div>
                <div class="text new">
					<div class="title"><?php  echo $this->set['texts']['commission1']?></div>
                    <div class=""><span><?php  echo number_format($member['credit3'],2)?></span> <?php  echo $this->set['texts']['yuan']?></div>
				</div>
            </a>
            <a style="border-bottom: 1px solid #ebebeb;" class="fui-block-child new external" href="<?php  echo mobileUrl('commission/order')?>">
				...
				<div class="text new">
					...
					<div class=""><span><?php  echo number_format($member['commission_count'],0)?></span> 笔</div>
				</div>
            </a>
            ...
            <a  style="border-bottom: 1px solid #ebebeb;" class="fui-block-child new  external" href="<?php  echo mobileUrl('commission/down')?>">
				...
				<div class="text new">
					...
					<div>
						<span><?php  echo number_format($member['downcount'],0)?></span>人
					</div>
					<div><?php  if(!empty($members) && $datas['checkpower'] == 1) { ?>
						<span style="color:red">待审核<?php  echo $members;?>人</span>
						<?php  } ?>
					</div>
				</div>
            </a>
	      <!-- 	<a style="border-bottom: 1px solid #ebebeb;" class="fui-block-child new  external" href="<?php  echo mobileUrl('commission/cashbe')?>">
                <div class="icon "  style="color: #ff6e02;"><i class="icon icon-qian"></i></div>
				<div class="text new">
					<div class="title"><?php  echo $_W['shopset']['trade']['othertext']?>明细</div>
				</div>
            </a> -->
		...
		<div class="fui-cell-group">
			...
			<a class="fui-cell" href="<?php  echo mobileUrl('commission/myshop/set')?>">
				...
				<div class="fui-cell-text">小店设置</div>
				<div class="fui-cell-remark" style="font-size: 0.5rem;"></div>
			</a>
			<?php  } ?>
			<?php  if($this->set['openselect']) { ?>
