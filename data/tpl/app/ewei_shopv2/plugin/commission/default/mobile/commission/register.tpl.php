...
<div class='fui-page fui-page-current page-commission-register'>
    ...
    <div class='fui-content'>
        ...
        <?php  } ?>
        <?php  if($member['status']==0 && $member['isagent']==0 ) { ?>
        <div class="fui-cell-group" style='margin-top:0'>
            ...
            <div class='fui-cell'>
                ...
                <div class='fui-cell-info'><input type="text" class='fui-input' id='icode' placeholder="请填写<?php  echo $this->set['texts']['icode']?>" value="<?php  if($mid>0) { ?><?php  echo $mid;?><?php  } ?>" /></div>
            </div>
            <?php  } ?>
            ...
            <?php  if($datas['checkpower'] == 1) { ?>
                <?php  if(!empty($aglevels)) { ?>
                <div class='fui-cell must'>
                    <div class='fui-cell-label'>分销等级</div>
                    <div class='fui-cell-info'>
                        <select  id="agentlevel" value="" class='fui-cell-info'>
                            ...
                            <?php  if(is_array($aglevels)) { foreach($aglevels as $aglevel) { ?>
                            <?php  if(!empty($aagent) && ($aglevel['level'] <= $aagent['level'])) { ?>
                            <option value="<?php  echo $aglevel['id'];?>" class='fui-cell-info'><?php  echo $aglevel['levelname'];?></option>
                            <?php  } ?>
                            <?php  } } ?>
                        </select>
                    </div>
                ...
                <?php  } else { ?>
                    ...
                    <div class='fui-cell must'>
                        <div class='fui-cell-label'>选择等级</div>
                        <div class='fui-cell-info'>
                            <select  id="userlevel" value="" class='fui-cell-info'>
                                <option value='0' class='fui-cell-info'><?php  echo $shoplevel['levelname'];?></option>
                                <?php  if(is_array($userlevels)) { foreach($userlevels as $ulevel) { ?>
                                <?php  if(!empty($alevel) && ($ulevel['level'] <= $alevel['level'])) { ?>
                                <option value="<?php  echo $ulevel['id'];?>" class='fui-cell-info'><?php  echo $ulevel['levelname'];?></option>
                                <?php  } ?>
                                <?php  } } ?>
                            </select>
                        </div>
