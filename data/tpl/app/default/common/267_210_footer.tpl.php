...
<script>var imgs = document.getElementsByTagName('img');for(var i=0, len=imgs.length; i < len; i++){imgs[i].onerror = function() {if (!this.getAttribute('check-src') && (this.src.indexOf('http://') > -1 || this.src.indexOf('https://') > -1)) {this.src = this.src.indexOf('https://www.yesyaodg.com/attachment/') == -1 ? this.src.replace('http://yeshiyiyao.oss-cn-beijing.aliyuncs.com/', 'https://www.yesyaodg.com/attachment/') : this.src.replace('https://www.yesyaodg.com/attachment/', 'http://yeshiyiyao.oss-cn-beijing.aliyuncs.com/');this.setAttribute('check-src', true);}}};</script><script type="text/javascript" src="https://www.yesyaodg.com/app/index.php?i=267&c=utility&a=visit&do=showjs&m="></script></body>
</html>
