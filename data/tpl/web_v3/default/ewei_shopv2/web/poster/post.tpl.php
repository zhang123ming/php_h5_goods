...
<style type='text/css'>
   ...
   <?php  } ?> 
    ...
    #poster .drag[type=nickname] { width:100px;height:25px; font-size:16px; font-family: 黑体;}
    ...
    $('form').submit(function(){
        ...
        $('.drag').each(function(){
            ...
            if(type=='nickname' ||type=='title' || type=='marketprice' || type=='productprice'){
                ...
                d.content = $('#diycontent').val();
                d.alignment=$('#alignment').val();
            } else if(type=='qr'){
                d.size = obj.attr('size');
            } else if(type=='img'){
                d.src = obj.attr('src');
            ...
            var imgset = $('#imgset'), nameset = $("#nameset"),qrset = $('#qrset');
             ...
             clearTimers();
               ...
               if(type=='img'){
                  ...
                  nameset.show();
                  var content = nameset.find('#diycontent');
                  ...
                  nametimer = setInterval(function(){
                       obj.find('#content').html(content.val());
           ...
           clearTimers();
            ...
            if(type=='qr'){
                ...
                if(typeof($('#content').val())=='undefined'){
                  img = '<div class=text id="content">自定义内容</div>';
                }else{
                  bind($('#content').parent());
                  return;
                }
