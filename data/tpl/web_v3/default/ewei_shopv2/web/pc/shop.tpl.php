...
<div class="page-header">
    ...
    当前位置：<span class="text-primary">商城设置</span>
</div>
...
<form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <?php  if(!empty($data['pc_logo'])) { ?>
                <a href='<?php  echo tomedia($data['pc_logo'])?>' target='_blank'>
                    <img src="<?php  echo tomedia($data['pc_logo'])?>"  style='width:100px;border:1px solid #ccc;padding:1px'/>
                </a>
            <?php  } ?>
            <?php  } ?>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <textarea name="data[pc_copyright]" class="form-control richtext" cols="70"  rows="5"><?php  echo $data['pc_copyright'];?></textarea>
        </div>
    </div>
