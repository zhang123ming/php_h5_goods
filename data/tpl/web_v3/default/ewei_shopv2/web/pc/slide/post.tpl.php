...
<div class="page-sub-toolbar">
        ...
        <a class="btn btn-primary btn-sm" href="<?php  echo webUrl('pc/slide/add')?>">添加新幻灯片</a>

        <?php  } ?>

        <a class="btn btn-default  btn-sm" href="<?php  echo webUrl('pc/slide')?>">返回列表</a>
    </span>
</div>



<form <?php if( ce('shop.adv' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <span class='help-block'>建议尺寸:1920 * 409 , 请将所有幻灯片图片尺寸保持一致</span>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <?php  echo tpl_form_field_color('backcolor',$item['backcolor']) ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <div class="input-group form-group" style="margin: 0;">
                ...
                <input type="text" value="<?php  echo $item['link'];?>" class="form-control valid" name="link" placeholder=""
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <input type="button" name="back" onclick='history.back()'
                   ...
                   <?php if(cv('shop.adv.add|shop.adv.edit')) { ?>style='margin-left:10px;'<?php  } ?> value="返回列表"
