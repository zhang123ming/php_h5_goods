...
<div class="page-header">当前位置<span class="text-primary">首页</span>
    </div>
...
<div class="page-content transparent">
    ...
    <div class="row">
        ...
        <div class="col-md-8" <?php  if($hideItem) { ?> style="display: none;"<?php  } ?>>
            <div class="ibox h300">
    ...
    <?php  if($ordercol) { ?>
        <div class="row" <?php  if($hideItem) { ?> style="display: none;"<?php  } ?>>
