...
<script language="javascript">
 ...
 var html = '<table class="table table-bordered table-condensed"><thead><tr class="active">';
	...
	for(var i=0;i<newlen;i++){
		...
		var val ={ id : "",title:titles, stock : "",presell : "",costprice : "",preprice:"",productprice : "",marketprice : "",weight:"",productsn:"",goodssn:"",virtual:virtuals };
		if( $(".option_id_" + ids).length>0){
			val ={
				...
				preprice : $(".option_preprice_" + ids+":eq(0)").val(),
		...
		hh += '<td><input data-name="option_preprice_' + ids+'" type="text" class="form-control option_preprice option_preprice_' + ids +'" value="' +(val.preprice=='undefined'?'':val.preprice )+'"/></td>';
