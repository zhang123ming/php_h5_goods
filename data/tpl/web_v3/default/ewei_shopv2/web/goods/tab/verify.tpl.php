 ...
 <div class="region-goods-details row">
     ...
     <div class="region-goods-right col-sm-10">
         <div class="form-group">
             ...
             <div class="col-sm-6 col-xs-6">
                 <?php if( ce('goods' ,$item) ) { ?>
                 <label class="radio-inline"><input type="radio" name="notselfverify" value="0" <?php  if(empty($item['notselfverify'])) { ?>checked="true"<?php  } ?>   /> 支持</label>
                 <label class="radio-inline"><input type="radio" name="notselfverify" value="1" <?php  if($item['notselfverify'] == 1) { ?>checked="true"<?php  } ?>  /> 不支持</label>
                 <?php  } else { ?>
                 <div class='form-control-static'>
                     <?php  if($item['notselfverify'] == 1) { ?>不支持<?php  } else { ?>支持<?php  } ?>
                 </div>
                 <?php  } ?>
