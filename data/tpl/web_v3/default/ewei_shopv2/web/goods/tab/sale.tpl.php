...
<div class="region-goods-details row">
    ...
    <div class="region-goods-right col-sm-10">
        <div class="form-group">
            <label class="col-sm-2 control-label">
                <?php  echo $_W['shopset']['trade']['credittext'];?>赠送
            </label>
            <div class="col-sm-9 col-xs-12">
                <?php if( ce('goods' ,$item) ) { ?>
                ...
                <p class="help-block">
                    会员购物赠送的<?php  echo $_W['shopset']['trade']['credittext'];?>, 如果不填写或填写0，则默认为不赠送<?php  echo $_W['shopset']['trade']['credittext'];?>，如果带%则为按成交价格的比例计算<?php  echo $_W['shopset']['trade']['credittext'];?>
                </p>
                <p class="help-block">
                    如: 购买2件，设置10 <?php  echo $_W['shopset']['trade']['credittext'];?>, 不管成交价格是多少， 则购买后获得20<?php  echo $_W['shopset']['trade']['credittext'];?>
                </p>
                <p class="help-block">
                    如: 购买2件，设置10%<?php  echo $_W['shopset']['trade']['credittext'];?>, 成交价格2 * 200= 400， 则购买后获得 40 <?php  echo $_W['shopset']['trade']['credittext'];?>（400*10%）
                </p>
                <?php  } else { ?>
                <div class='form-control-static'>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <?php if( ce('goods' ,$item) ) { ?>
                <div class="input-group fixsingle-input-group">
                    <input type="text" name="inviter_credit" id="inviter_credit" class="form-control" value="<?php  echo $item['inviter_credit'];?>"/>
                <span class="input-group-addon">
                                分
                            </span>
                </div>
                <p class="help-block">
                    用户购买上级获得积分, 如果不填写或填写0，则默认为不赠送积分，如果带%则为按成交价格的比例计算积分
                </p>
                <p class="help-block">
                ...
                <?php  } else { ?>
                <div class='form-control-static'>
                    <?php  echo $item['inviter_credit'];?> 分
                </div>
                <?php  } ?>
            </div>
        </div>
...
<div class="region-goods-details row">
    ...
    <div class="region-goods-right col-sm-10">
        <div class="form-group">
            <label class="col-sm-2 control-label">
                <?php  echo $_W['shopset']['trade']['credittext'];?>抵扣
            </label>
            <div class="col-sm-9 col-xs-12">
                <?php if( ce('goods' ,$item) ) { ?>
                <div class='input-group fixsingle-input-group'>
            ...
            <span class="help-block">
                            如果设置0，则不支持<?php  echo $_W['shopset']['trade']['credittext'];?>抵扣
                        </span>
                <?php  } else { ?>
                <div class='form-control-static'>
                    <?php  if(empty($item['deduct'])) { ?>不支持<?php  echo $_W['shopset']['trade']['credittext'];?>抵扣<?php  } else { ?>最多抵扣 <?php  echo $item['deduct'];?> 元 <?php  if(empty($item['manydeduct'])) { ?>不允许多件累计抵扣<?php  } else { ?>允许多件累计抵扣
                    <?php  } ?><?php  } ?>
                </div>
                <?php  } ?>
            </div>
    ...
    <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <div class='input-group fixsingle-input-group'>
                        ...
                        <input type="text" name="coupondeduct" value="<?php  echo $item['coupondeduct'];?>" class="form-control"
                        />
                                <span class="input-group-addon">
                                    元
                                </span>
