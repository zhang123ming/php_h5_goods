...
<div class="page-header"> 当前位置：<span class="text-primary"></span></div>
...
<div class="page-content">
    ...
    <table class="table">
        ...
        <tr class="trbody" style="border: 1px solid #efefef;">
            <td><img src="<?php  echo tomedia($row['thumb'])?>" style="width: 50px; height: 50px;border:1px solid #ccc;padding:1px;"  onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'" ></td>
            ...
            <td> <a  data-toggle='popover' data-placement='bottom' data-html='true' data-trigger='hover' style="width: 100%;height: 100;cursor: pointer;"
                        ...
                        <tr><th><?php  echo $_W['shopset']['trade']['credittext'];?>抵扣</th><td><?php  if($row['deductprice']>0) { ?>-<?php  echo $row['deductprice'];?><?php  } ?></td></tr>
