...
<div class="form-group">
    <label class="col-lg control-label">推送图片</label>
    <div class="col-sm-9 col-xs-12">
        <?php  echo tpl_form_field_image2('custhumb', $data['custhumb'])?>
    </div>
</div>
<div class="form-group">
    <label class="col-lg control-label">推送描述</label>
    <div class="col-sm-9 col-xs-12">
        <textarea id="cusdesc" name="cusdesc" class="form-control" rows="5" ><?php  echo $data['cusdesc'];?></textarea>
    </div>
</div>
<div class="form-group">
