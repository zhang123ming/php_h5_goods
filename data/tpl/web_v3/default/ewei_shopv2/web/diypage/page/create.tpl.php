                    ...
                    <div class="ibox-content">
                        ...
                        <center style="position: relative; width: 100%">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                ...
                                <?php  } ?>
                                <?php  if(p('creditshop')) { ?>
                                    <li><span class="btn btn-w-m btn-block btn-outline btn-danger btn-jump" data-href="<?php  echo webUrl('diypage/page/plu/add', array('type'=>6, 'tid'=>$tid_creditshop))?>"><i class="fa fa-plus"></i> <?php  echo $_W['shopset']['trade']['credittext'];?>商城</span></li>
                                <?php  } ?>
                                <?php  if(p('seckill')) { ?>
    ...
    <div class="col-sm-12">
        <div class="summary_box" style="background: #fff">
            ...
            <div class="summary_lg">
                ...
                <?php  if($_W['plugin']!='merch') { ?>
                <p>应用页面：可根据自己需求、样式编辑好页面，替换应用默认模板<?php  if(p('commission')||p('creditshop')||p('seckill')||p('exchange')) { ?>，目前支持<?php  if(p('commission')) { ?>分销中心<?php  } ?><?php  if(p('creditshop')) { ?>、<?php  echo $_W['shopset']['trade']['credittext'];?>商城<?php  } ?><?php  if(p('seckill')) { ?>、整点秒杀<?php  } ?><?php  if(p('exchange')) { ?>、兑换中心<?php  } ?>。<?php  } else { ?>。<?php  } ?></p>
                <?php  } ?>
