...
<script type="text/html" id="tpl_edit_richtext">
    <div class="form-group">
        <div class="col-sm-2 control-label">背景1颜色</div>
        <div class="col-sm-4">
            <div class="input-group input-group-sm">
                <input class="form-control input-sm diy-bind color" data-bind-child="style" data-bind="background" value="<%style.background%>" type="color" />
                <span class="input-group-addon btn btn-default" onclick="$(this).prev().val('#ffffff').trigger('propertychange')">清1除</span>
            </div>
        </div>
    </div>
...
<script type="text/html" id="tpl_edit_search">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <!-- <label class="radio-inline"><input type="radio" name="goodstype" value="1" class="diy-bind" data-bind-child="params" data-bind="goodstype" <%if params.goodstype=='1'%>checked="checked"<%/if%> > <?php  echo $_W['shopset']['trade']['credittext'];?>商城商品</label> -->
        </div>
    </div>
...
<script type="text/html" id="tpl_edit_task2">
...
<script type="text/html" id="tpl_edit_goods">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <!-- <label class="radio-inline"><input type="radio" name="goodstype" value="1" class="diy-bind" data-bind-child="params" data-bind="goodstype" data-bind-init="true" <%if params.goodstype=='1'%>checked="checked"<%/if%> > <?php  echo $_W['shopset']['trade']['credittext'];?>商城商品</label> -->
            <%/if%>
            <!-- <label class="radio-inline"><input type="radio" name="goodstype" value="2" class="diy-bind" data-bind-child="params" data-bind="goodstype" data-bind-init="true" <%if params.goodstype=='2'%>checked="checked"<%/if%> > 招商</label> -->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <%if params.goodstype==1%>
                <label class="radio-inline"><input type="radio" name="goodsdata" value="9" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='9'%>checked="checked"<%/if%> > <?php  echo $_W['shopset']['trade']['credittext'];?>兑换商品</label>
                <label class="radio-inline"><input type="radio" name="goodsdata" value="10" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='10'%>checked="checked"<%/if%> > <?php  echo $_W['shopset']['trade']['credittext'];?>抽奖商品</label>
            <%/if%>
        </div>
    </div>
                    ...
                    <div class="item-form">
                        ...
                        <%else%>
                            <div class="input-group" style="margin-top:10px; margin-bottom:0px; ">
                                ...
                                <span class="input-group-addon"><?php  echo $_W['shopset']['trade']['credittext'];?></span>
                            </div>
                        <%/if%>
                    </div>
                </div>
...
<script type="text/html" id="tpl_edit_listmenu">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="form-group">
                <div class="slider col-sm-8" data-value="<%style.fontsize%>" data-min="0" data-max="50"></div>
                <div class="col-sm-4 control-labe count"><span><%style.fontsize%></span>px(像素)</div>
                <input class="diy-bind input" data-bind-child="style" data-bind="fontsize" value="<%style.fontsize%>" type="hidden" />
            </div>
        </div>
...
<script type="text/html" id="tpl_edit_member">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="form-group">
                <div class="slider col-sm-8" data-value="<%style.fontsize%>" data-min="12" data-max="30"></div>
                <div class="col-sm-4 control-labe count"><span><%style.fontsize%></span>px(像素)</div>
                <input class="diy-bind input" data-bind-child="style" data-bind="fontsize" value="<%style.fontsize%>" type="hidden" />
            </div>
        </div>
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">按钮</div>
        <div class="col-sm-10">
            <div class="input-group input-group-sm">
                <span class="input-group-addon">文字</span>
                <input class="form-control input-sm diy-bind" data-bind-child="params" data-bind="defaultnav" value="<%params.defaultnav%>" style="width: 100px;" maxlength="4" placeholder="最大四字" />
                <span class="input-group-addon noblr">链接</span>
                <input class="form-control input-sm diy-bind" id="defaultnavlink" data-bind-child="params" data-bind="defaultnavlink" value="<%params.defaultnavlink%>" placeholder="按钮链接" />
                <span class="input-group-addon btn btn-default" data-toggle="selectUrl" data-input="#defaultnavlink">选择链接</span>
            </div>
        </div>
    </div>
    <%/if%>
...
<script type="text/html" id="tpl_edit_icongroup">
    <div class="form-group">
        ...
        <div class="col-sm-2 control-label">图标大小</div>
        <div class="col-sm-10">
            <div class="form-group">
                <div class="slider col-sm-8" data-value="<%style.fontsize2%>" data-min="12" data-max="30"></div>
                <div class="col-sm-4 control-labe count"><span><%style.fontsize2%></span>px(像素)</div>
                <input class="diy-bind input" data-bind-child="style" data-bind="fontsize2" value="<%style.fontsize2%>" type="hidden" />
            </div>
        </div>
    </div>
    <div class="form-group">
...
<script type="text/html" id="tpl_edit_memberc">
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">隐藏邀请码</div>
        <div class="col-sm-10">
            <label class="radio-inline"><input type="radio" name="hidecode" value="0" class="diy-bind" data-bind-child="params" data-bind="hidecode" data-bind-init="true" <%if params.hidecode==0 || !params.hidecode%>checked="checked"<%/if%>> 不隐藏</label>
            <label class="radio-inline"><input type="radio" name="hidecode" value="1" class="diy-bind" data-bind-child="params" data-bind="hidecode" data-bind-init="true" <%if params.hidecode==1%>checked="checked"<%/if%> > 隐藏</label>
        </div>
    </div>
    <%/if%>
...
<script type="text/html" id="tpl_edit_detail_info">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        <div class="col-sm-2 control-label">商品价格</div>
        <div class="col-sm-10">
            <label class="radio-inline"><input type="radio" name="hideprice" value="0" class="diy-bind" data-bind-child="params" data-bind="hideprice" data-bind-init="true" <%if params.hideprice=='0' || !params.hideprice%>checked="checked"<%/if%> > 显示</label>
            <label class="radio-inline"><input type="radio" name="hideprice" value="1" class="diy-bind" data-bind-child="params" data-bind="hideprice" data-bind-init="true" <%if params.hideprice=='1'%>checked="checked"<%/if%>> 隐藏</label>
        </div>
    </div>
...
<script type="text/html" id="tpl_edit_exchange_input">
    ...
    <%if params.preview=='1'%>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><?php  echo $_W['shopset']['trade']['credittext'];?>图标</div>
            <div class="col-sm-10">
                <div class="input-group input-group-sm">
                    <span class="input-group-addon" style="padding: 0; width: 30px;">
