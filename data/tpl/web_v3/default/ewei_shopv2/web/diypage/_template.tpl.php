...
<script type="text/html" id="tpl_show_task2">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-picture" style="padding-bottom: <%style.paddingtop%>px; background: <%style.background%>;">
            <%each data as item%>
                <div style="display: block; padding: <%style.paddingtop%>px <%style.paddingleft%>px 0;">
                                    ...
                                    <span class="text" style="color: <%style.pricecolor%>;">
                                        <p class="minprice">
                                            ...
                                            <%else%>
                                                ...
                                                <%if item.price==0&&item.credit>0%><%item.credit%><small><?php  echo $_W['shopset']['trade']['credittext'];?></small><%/if%>
                                                <%if item.price>0&&item.credit>0%><%item.credit%><small><?php  echo $_W['shopset']['trade']['credittext'];?></small>+<%item.price%><small>元</small><%/if%>
                                            <%/if%>
                                        </p>
                                    </span>
                        ...
                        <div class="detail">
                            <%if params.showtitle=='1'%>
                                <div class="name">
                                    ...
                                    <%/if%>
                                    这里是商品标题(商品从设定<%if params.goodsdata=='1'%>分类<%/if%><%if params.goodsdata=='2'%>分组<%/if%><%if params.goodsdata=='3'%>新品商品<%/if%><%if params.goodsdata=='4'%>热卖商品<%/if%><%if params.goodsdata=='5'%>推荐商品<%/if%><%if params.goodsdata=='6'%>促销商品<%/if%><%if params.goodsdata=='7'%>包邮商品<%/if%><%if params.goodsdata=='8'%>限时卖商品<%/if%><%if params.goodsdata=='9'%><?php  echo $_W['shopset']['trade']['credittext'];?>兑换商品<%/if%><%if params.goodsdata=='10'%><?php  echo $_W['shopset']['trade']['credittext'];?>抽奖商品<%/if%>读取)</div>
                            <%/if%>
                            <%if params.showprice=='1'%>
                            <p class="productprice <%if (params.showproductprice !=1) && (params.showsales !=1)%>noheight<%/if%>">
                                    ...
                                    <span class="text" style="color: <%style.pricecolor%>;">
                                        <p class="minprice">
                                            <%if params.goodstype==0||!params.goodstype%>
                                                ￥20.00
                                            <%else%>
                                                10<small><?php  echo $_W['shopset']['trade']['credittext'];?></small>+20<small>元</small>
                                            <%/if%>
                                        </p>
                                    </span>
    ...
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-cell-click" style="margin-top: <%style.margintop%>px; background-color: <%style.background%>;">
            <%each data as item%>
                <div class="fui-cell">
                    <%if item.iconclass%>
                        <div class="fui-cell-icon" style="color: <%style.iconcolor%>;font-size: <%style.fontsize%>px;"><i class="icon <%item.iconclass%>" style="font-size: <%style.fontsize%>px;"></i></div>
                    <%/if%>
                    <div class="fui-cell-text" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;margin-left:5px; "><%item.text%></div>
                    <div class="fui-cell-remark" style="color: <%style.remarkcolor%>;font-size: <%style.fontsize%>px;"><%item.remark%></div>
                </div>
            <%/each%>
        </div>
    </div>
    ...
    <div class="drag" data-itemid="<%itemid%>">
        ...
        <div style="overflow: hidden;height: 7.5rem;position: relative;background: #fff">
            <div class="headinfo" style="z-index:1001;border: none;">
                <div class="setbtn" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;"><i class="icon <%params.seticon%>"></i></div>
                <div class="child">
                    <div class="title" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;">余额</div>
                    <div class="num" style="color: <%style.textlight%>;font-size: <%style.fontsize%>px;">123.50</div>
                    <%if params.leftnav%>
                    <div class="btn" style="color: <%style.textcolor%>; border-color: <%style.textcolor%>;font-size: <%style.fontsize%>px;"><%params.leftnav%></div>
                    <%/if%>
                </div>
                <div class="child userinfo" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;">
                    <div class="face <%style.headstyle%>"><img src="../addons/ewei_shopv2/static/images/nopic100.jpg"></div>
                    <div class="name" style="font-size: <%style.fontsize%>px;">用户昵称</div>
                    <div class="level" style="font-size: <%style.fontsize%>px;">[用户等级] <i class="icon icon-question1" style="font-size: <%style.fontsize%>px;"></i></div>
                </div>
                <div class="child">
                    <div class="title" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;"><?php  echo $_W['shopset']['trade']['credittext'];?></div>
                    <div class="num" style="color: <%style.textlight%>;font-size: <%style.fontsize%>px;">54321</div>
                    <%if params.rightnav%>
                    <div class="btn" style="color: <%style.textcolor%>; border-color: <%style.textcolor%>;font-size: <%style.fontsize%>px;"><%params.rightnav%></div>
                    <%/if%>
                </div>
            </div>
            <div class="member_header" style="background: <%style.background%>;border-color: <%style.background%>;font-size: <%style.fontsize%>px;"></div>
        </div>
        <%/if%>
        ...
        <div class="headinfo style-2" style="background: <%style.background%>; <%if style.background%>border: none;<%/if%>">
            ...
            <div class="inner" style="color: <%style.textcolor%>;">
                <div class="name" style="font-size: <%style.fontsize%>px;">Change.</div>
                <div class="level" style="font-size: <%style.fontsize%>px;">[用户等级] <i class="icon icon-question1" style="font-size: 12px;"></i></div>
                <div class="credit" style="font-size: <%style.fontsize%>px;">余额: <span style="color: <%style.textlight%>;">123.50</span></div>
                <div class="credit" style="font-size: <%style.fontsize%>px;"><?php  echo $_W['shopset']['trade']['credittext'];?>: <span style="color: <%style.textlight%>;">54321</span></div>
            </div>
        </div>
        <%/if%>
        ...
        <div class="headinfo style-2" style="background: <%style.background%>; <%if style.background%>border: none;<%/if%>">
            ...
            <div class="child" style="width: 40%;">
                <div class="level" style="font-size: <%style.fontsize%>px;">[用户等级]</div>
                <%if params.defaultnav%>
                <div class="btn" style="color: <%style.textcolor%>; border-color: <%style.textcolor%>;width: 70px;font-size: <%style.fontsize%>px;"><%params.defaultnav%></div>
                <%/if%>
            </div>
        </div>
        <%/if%>
        ...
        <div class="fui-icon-group noborder col-<%params.rownum%> selecter" style="background-color: <%style.background%>; <%if params.bordertop=='1'%>border-top: 1px solid <%style.bordercolor%>;<%else%>border-top: none;<%/if%> <%if params.borderbottom=='1'%>border-bottom: 1px solid <%style.bordercolor%>;<%else%>border-bottom: none;<%/if%>">
            ...
            <%each data as child itemid %>
                <div class="fui-icon-col external" style="<%if params.border=='1'&&index>0%>border-left: 1px solid <%style.bordercolor%>;<%else%>border-left: none;<%/if%>">
                    ...
                    <div class="icon icon-green radius"><i class="icon <%child.iconclass%>" style="color: <%style.iconcolor%>;font-size: <%style.fontsize2%>px;"></i></div>
                    <div class="text" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;"><%child.text%></div>
                </div>
            <%define index++%>
            <%/each%>
        </div>
...
<script type="text/html" id="tpl_show_bindmobile">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-cell-click" style="margin-top: <%style.margintop%>px; background-color: <%style.background%>;">
            <div class="fui-cell">
                <div class="fui-cell-text" style="color: <%style.titlecolor%>;font-size: <%style.fontsize%>px;">
                    <%if params.iconclass%>
                    <i class="icon <%params.iconclass%>" style="color: <%style.iconcolor%>;font-size: <%style.fontsize%>px;"></i>
                    <%/if%>
                    <%params.title%>
                    <%if params.text%>
                    <div class="" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;"><%params.text%></div>
                    <%/if%>
                </div>
                <div class="fui-cell-remark" style="font-size: <%style.fontsize%>px;"></div>
            </div>
...
<script type="text/html" id="tpl_show_memberc">
    <div class="drag" data-itemid="<%itemid%>">
        ...
        <div class="headinfo commission" style="background-color: <%style.background%>;">
            <div class="userinfo" style="border-bottom: 1px solid <%style.textcolor%>;">
                <div class="fui-list">
                    ...
                    <div class="fui-list-info">
                        <div class="title" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;">用户昵称</div>
                        <div class="subtitle" style="color: <%style.textlight%>;font-size: <%style.fontsize%>px;">&lt;分销商等级&gt;</div>
                        <%if params.hideup==0 || !params.hideup%>
                        <div class="text" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;">推荐人: 总店</div>
                        <%/if%>
                    </div>
                </div>
                <%if params.seticon%>
            ...
            <div class="userblock">
                <div class="line total">
                    <div class="title" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;">成功提现佣金(元)</div>
                    <div class="num" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;">0.00</div>
                </div>
                <div class="line usable">
                    ...
                    <%/if%>
                    <div class="text">
                        <div class="title" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;">可提现佣金(元)</div>
                        <div class="num" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;">0.00</div>
                    </div>
                </div>
            </div>
        ...
        <div class="headinfo" style="background: <%style.background%>; <%if style.background%>border: none;<%/if%>">
            ...
            <div class="child">
                <div class="title" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;">成功提现佣金</div>
                <div class="num" style="color: <%style.textlight%>;font-size: <%style.fontsize%>px;">123.50</div>
                <%if params.leftnav%>
                <div class="btn" style="color: <%style.textcolor%>; border-color: <%style.textcolor%>;font-size: <%style.fontsize%>px;"><%params.leftnav%></div>
                <%/if%>
            ...
            <div class="child userinfo" style="color: <%style.textcolor%>;">
                <div class="face <%style.headstyle%>"><img src="../addons/ewei_shopv2/static/images/nopic100.jpg"></div>
                <div class="name" style="font-size: <%style.fontsize%>px; margin-top:0.5px;">用户昵称</div>
                <div class="level"style="font-size: <%style.fontsize%>px;">[分销商等级]</div>
                <%if params.hideup==0 || !params.hideup%>
                <div class="level" style="font-size: <%style.fontsize%>px;">推荐人: 总店</div>
                <%/if%>
            </div>
            <div class="child">
                <div class="title" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;">可提现佣金</div>
                <div class="num" style="color: <%style.textlight%>;font-size: <%style.fontsize%>px;">54321</div>
                <%if params.rightnav%>
                <div class="btn" style="color: <%style.textcolor%>; border-color: <%style.textcolor%>;font-size: <%style.fontsize%>px;"><%params.rightnav%></div>
                <%/if%>
        ...
        <%/if%>
        <%if params.style=='default3'%>
        <div style="background: <%style.background%>; <%if style.background%>border: none;<%/if%>">
            <div style="color: <%style.textcolor%>;font-size: <?php  echo $diyitem['style']['fontsize'];?>px; border:none; text-align:center; padding-top:15px;">我的<?php  echo $_W['shopset']['commission']['texts']['commission_superior'];?>: 总店</div>
            <div style="color: <%style.textcolor%>;font-size: <?php  echo $diyitem['style']['fontsize'];?>px; border:none; text-align:center;">ID:22406</div>
            <div class="headinfo" style="border:none;">
                <div class="setbtn" style="color: <%style.textcolor%>;"><i class="icon <%params.seticon%>"></i></div>
                <div class="child">
                    <div class="num" style="color: <%style.textlight%>;font-size: <%style.fontsize%>px;">￥123.50</div>
                    <div class="title" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;padding-top:10px;">今日<?php  echo $_W['shopset']['commission']['texts']['commission'];?></div>
                </div>
                <div class="child">
                    <div class="num" style="color: <%style.textlight%>;font-size: <%style.fontsize%>px;">￥54321</div>
                    <div class="title" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;padding-top:10px;">本月<?php  echo $_W['shopset']['commission']['texts']['commission'];?></div>
                   
                </div>
                <div class="child">
                    <div class="num" style="color: <%style.textlight%>;font-size: <%style.fontsize%>px;">￥54321</div>
                    <div class="title" style="color: <%style.textcolor%>;font-size: <%style.fontsize%>px;padding-top:10px;">全部<?php  echo $_W['shopset']['commission']['texts']['commission'];?></div>
...
<script type="text/html" id="tpl_show_blockgroup">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-block-group col-<%params.rownum%>" style="margin-top:0; overflow: hidden; background-color: <%style.background%>;font-size: <%style.fontsize%>px;">
            <%each data as item%>
            <div class="fui-block-child" style="background-color: <%style.background%>;font-size: <%style.fontsize%>px;">
                <div class="icon" style="color: <%item.iconcolor%>;font-size: <%style.fontsize%>px;"><i class="icon <%item.iconclass%>"></i></div>
                <div class="title" style="color: <%item.textcolor%>;font-size: <%style.fontsize%>px;"><%item.text%></div>
                <div class="text">
                <%if item.tipnum%>
                <span style="color: <%style.tipcolor%>;font-size: <%style.fontsize%>px;"><%item.tipnum%></span> <%item.tiptext%>
                <%/if%>
                </div>
            </div>
            <%/each%>
...
<script type="text/html" id="tpl_show_detail_info">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-detail-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px;">
            ...
            <%if params.hideprice=='0'||!params.hideprice%>
            <div class="fui-cell">
        ...
        <div class="fui-cell-group fui-cell-click  fui-sale-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px;">
            ...
            <div class="fui-cell">
                ...
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">
                    ...
                    <div class="sale-line">
                        <span class="sale-tip" style="border-color: <%style.textcolorhigh%>; color: <%style.textcolorhigh%>;"><?php  echo $_W['shopset']['trade']['credittext'];?></span>
                        <span>购买赠送<span class="text-danger" style="color: <%style.textcolorhigh%> !important;">10</span><?php  echo $_W['shopset']['trade']['credittext'];?></span>
                    </div>
                    <div class="sale-line">
            ...
            <%if params.preview==1%>
                <div class="list">
                    ...
                    <div class="item">
                        ...
                        <div class="info">
                            <p class="t1" style="color: <%style.goodstitle%>;"><?php  echo $_W['shopset']['trade']['credittext'];?>兑换</p>
                            <p class="t2" style="color: <%style.goodsprice%>;">面值：1000元</p>
                        </div>
                        <div class="btn-exc btn btn-danger btn-sm" style="color: <%style.exbtncolor%>; background: <%style.exbtnbackground%>"><%params.exbtntext||'兑换'%></div>
                    </div>
