...
<div class="page-header">当前位置：<span class="text-primary">添加部门</span></div>
		...
		<div class="tabs">
			...
			<div class="tab-content ">
				...
				<div class="form-group">
				    <label class="col-lg control-label">部门名称 :</label>
				    <div class="col-sm-9 col-xs-12">
				        <input class="form-control" type="text" name="detp_name"  value="" />
				    </div>
				</div>
			</div>
		</div>
