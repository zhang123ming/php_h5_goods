...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
            <div class="form-control-static js-clip text-primary"><?php  echo $member['openid'];?></div>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <label class="col-lg control-label">所属商户[慎重修改] :</label>
    <div class="col-sm-9 col-xs-12">
        <input class="form-control" type="text" name="data[shop_id]"  value="<?php  echo $member['shop_id'];?>" />
    </div>
</div>
<div class="form-group">
    <label class="col-lg control-label">所属门店[慎重修改] :</label>
    <div class="col-sm-9 col-xs-12">
        <input class="form-control" type="text" name="data[store_id]"  value="<?php  echo $member['store_id'];?>" />
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <label class="col-lg control-label"><?php  echo $_W['shopset']['trade']['credittext'];?>上限</label>
    <div class="col-sm-9">
        ...
        <span class='help-block text-danger'>会员<?php  echo $_W['shopset']['trade']['credittext'];?>上限，0为不限制(后台手动充值不限制，已持有<?php  echo $_W['shopset']['trade']['credittext'];?>不限制，保存后生效)</span>
        <?php  } ?>
    </div>
</div>

<div class="form-group">
    <label class="col-lg control-label"><?php  echo $_W['shopset']['trade']['credittext'];?></label>
    <div class="col-sm-3">
...
<?php if(cv('member.myteam.edit')) { ?>
<div class="form-group">
    <label class="col-lg control-label">下级名额</label>
    <div class="col-sm-3">
        <div class='form-control-static'><input type="number" name="data[memberlimit]" class="form-control" value="<?php  echo $member['memberlimit'];?>" min="0" style="width: 100px;display:inline-block"/>
        </div>
    </div>
</div>
<?php  } ?>
...
<div class="form-group" style="display:  none;">
    <label class="col-lg control-label">是否开通服务奖</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('member.list.edit')) { ?>
        <label class="radio-inline"><input type="radio" name="data[is_allowance]" value="1" <?php  if($member['is_allowance']==1) { ?>checked<?php  } ?>>是</label>
        <label class="radio-inline" ><input type="radio" name="data[is_allowance]" value="0" <?php  if($member['is_allowance']==0) { ?>checked<?php  } ?>>否</label>
        <span class="help-block">开通服务奖后，此会员享有服务奖</span>
        <?php  } else { ?>
        <input type='hidden' name='data[is_allowance]' value='<?php  echo $member['is_allowance'];?>' />
        <div class='form-control-static'><?php  if($member['is_allowance']==1) { ?>是<?php  } else { ?>否<?php  } ?></div>
        <?php  } ?>
