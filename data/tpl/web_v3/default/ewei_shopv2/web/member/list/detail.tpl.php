	...
	<div class="tabs-container">
		...
		<div class="tabs">
			...
			<div class="tab-content ">
				...
				<?php  } else { ?>
					<div id="tab-basic" class="tab-pane active"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('member/detail/basic1', TEMPLATE_INCLUDEPATH)) : (include template('member/detail/basic1', TEMPLATE_INCLUDEPATH));?></div>
				<?php  } ?>
