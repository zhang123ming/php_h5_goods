...
<div class="page-content">
    ...
    <form action="./index.php" method="get" class="form-horizontal table-search" role="form">
        ...
        <?php if(cv('member.list.add')) { ?>
        <a class="btn btn-primary btn-sm" href="<?php  echo webUrl('member/list/detail',array('isAdd'=>1));?>"><i class="fa fa-plus"></i> 添加会员</a>
        <?php  } ?>
        <a class="btn btn-primary btn-sm" href="<?php  echo webUrl('member/list/tree');?>"> 查看会员结构树</a>
            ...
            <div class="col-md-12">
                ...
                <table class="table table-responsive">
                    ...
                    <tr>
                        ...
                        <th style="">等级/分组</th>
                        <th style="">注册时间</th>
                        <th style=""><?php  echo $_W['shopset']['trade']['credittext'];?>/余额</th>
                        <th style="">成交</th>
                    ...
                    <tbody>
                        ...
                        <?php  } ?> <br/>
                            ...
                            <td><?php  if(empty($row['levelname'])) { ?>普通会员<?php  } else { ?><?php  echo $row['levelname'];?><?php  } ?>
                                <br/><?php  if(empty($row['groupname'])) { ?>无分组<?php  } else { ?><?php  echo $row['groupname'];?><?php  } ?>
                            </td>

                            <td><?php  echo date("Y-m-d",$row['createtime'])?><br/><?php  echo date("H:i:s",$row['createtime'])?></td>
                            <td><span ><?php  echo $_W['shopset']['trade']['credittext'];?>:  <span style="color: #5097d3"><?php  echo intval($row['credit1'])?></span> </span>
                            ...
                            <td style="overflow:visible;text-align: center;">
                                ...
                                <div class="btn-group">
                                       ...
                                       <a class="btn  btn-op btn-operation" data-toggle="ajaxModal"
                                        ...
                                        <?php  } ?>
                                       <?php  if($_W['shopset']['shop']['isdeclaration']==1) { ?>
                                       <a class="btn  btn-op btn-operation" data-toggle="ajaxModal"
                                               href="<?php  echo webUrl('finance/declaration', array('type'=>'declaration','id'=>$row['id']))?>"
                                               title=''>
                                                 <span data-toggle="tooltip" data-placement="top" title="" data-original-title="报单">
                                                   <i class='icow icow-order'></i>
                                                </span>
                                       </a>
                                        <?php  } ?>
                                        <?php  if($_W['shopset']['machine']['machineMode']==2) { ?>
                                             <a class="btn  btn-op btn-operation" data-toggle="ajaxModal"
                                               href="<?php  echo webUrl('member/agent/groupholder', array('id'=>$row['id']))?>"
                                               title=''>
                                                 <span data-toggle="tooltip" data-placement="top" title="" data-original-title="项目股东">
...
<script language="javascript">
    $("#sync").on('click',function(){
        $(function () {
            $.ajax({
                type: "GET",
                url: "<?php  echo webUrl('member/list/ajaxSync')?>",
                dataType: "json",
                success: function (data) {
                    console.log(data)
                     ...
                     $("#modal-change").modal('hide');
                    if(data.status==1){
                        tip.msgbox.suc('已同步'+data.result.nums+'个用户积分');
                        setTimeout(function () {
                            location.reload();
                        },2000);
                    }else{
