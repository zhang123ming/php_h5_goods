...
<style>
	...
	.form-horizontal .checkbox-inline{margin:1px 5px 4px 0;}
</style>
 <div class="page-header">当前位置：<span class="text-primary">数据清理</span></div>
	  ...
	  <form id="dataform" action="" method="post" class="form-horizontal form-validate">
		  ...
		  <div class="form-group">
			  ...
			  <div class="col-sm-9">
				  ...
				  <label class="checkbox-inline">
					  <input type='checkbox' value="membercredit1" name="shop[]" /> 会员<?php  echo $_W['shopset']['trade']['credittext'];?>(清除所有会员的<?php  echo $_W['shopset']['trade']['credittext'];?>)
				  </label>
				  <label class="checkbox-inline">
		  ...
		  <div class="form-group">
			  <label class="col-lg control-label">超级海报</label>
			  <div class="col-sm-9">
				  <div>
					  <label class="checkbox-inline">
		  ...
		  <div class="form-group">
			  <label class="col-lg control-label">
				  <?php  echo $_W['shopset']['trade']['credittext'];?>商城
			  </label>
			  <div class="col-sm-9">
				  <div>
					  <label class="checkbox-inline">
