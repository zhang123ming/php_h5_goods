...
<span class='pull-right'>
   <?php  if(!empty($result['status'])) { ?><span class='label label-primary'>更新服务到期时间:  <?php  echo $result['result']['auth_date_end'];?></span><?php  } ?>
   </span>
	...
	<form action="" method="post" class="form-horizontal" role="form">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="input-group">
                <div class="input-group-addon" style="background:#f2f2f2">商城&nbsp;V3.<?php  echo $ver;?>&nbsp;商业版</div>
		...
		<div class="form-group">
			...
			<?php  } else { ?>
			<div class="col-sm-10">
				<p class="form-control-static"><span class="fa fa-square-o"></span> &nbsp; [待更新的版本]：<span style="color:#FF0019;">&nbsp;商城&nbsp;V3.<?php  echo $lastver;?>&nbsp;商业版</p>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<div class="help-block"><strong><span style="color:#FF0019;">[商城&nbsp;V3.<?php  echo $lastver;?>&nbsp;商业版更新内容]：</strong></div>
				<div id='count' class="alert alert-info" style="line-height:20px;">
				<div><span style="display:inline-block;"><?php  echo $cinfo;?></span></div>
				</div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">日期</label>
			<div class="col-sm-10">
				<p class="form-control-static"><span class="fa fa-square-o"></span> &nbsp; [授权时间截止]：<?php  if($domain_time == '0') { ?><i class="line_s fa fa-exclamation-triangle"></i> <span style="color:#FF0019;">&nbsp;授权已过期，购买授权：</span>
				<?php  } else { ?>
				<span style="color:#FF0019;">永久授权</span>&nbsp;&nbsp;<i class="line_s fa fa-refresh"></i> 
				<?php  } ?></p>
			</div>
		...
		<div class="form-group">
			<label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">最新</label>
			<div class="col-sm-10">
				<div id='count'  class="form-control-static"><span class="fa fa-square-o"></span> &nbsp; [最新系统版本]：<span style="color:#FF0019;">&nbsp;恭喜, 你的程序已经是最新版本
			</div>
		</div>
			</div>
		</div>
