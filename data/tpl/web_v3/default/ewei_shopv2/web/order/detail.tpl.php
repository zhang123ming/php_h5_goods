...
<div class="page-content">
                ...
                <div class="row">
                    ...
                    <tr>
                        ...
                        <?php  } else if($coupon['backtype']==2) { ?>
                            ...
                            <?php  if($coupon['backcredit']>0) { ?>返 <?php  echo $coupon['backcredit'];?> <?php  echo $_W['shopset']['trade']['credittext'];?><?php  } ?>
    ...
    "><i class='icow icow-help' style="font-size: 13px;color: #2f3434;margin-left: -3px"></i></a>
                    ...
                    <?php if(cv('order.op.changedetail')) { ?>
                    <div class="col-md-12 ops">
                        <?php  if($item['merchid'] == 0) { ?><a class="btn btn-primary" style="margin-left: 10px" data-toggle="ajaxModal" href="<?php  echo webUrl('order/op/changedetail', array('id' => $item['id']))?>">修改客户信息</a><?php  } ?>
                    </div>
                    <?php  } ?>
                    ...
                    <tr>
                        ...
                        <td  style='border:none;text-align:right;'><?php  echo date('Y-m-d H:i',$v['verifytime'])?></td>
                            ...
                            <li class="text">
                                ...
                                <?php  if(!empty($userthumb)) { ?>
                                <div><span>身份证号：</span><span><?php  echo $userthumb['userid'];?></span></div>
                                <img style="width:300px;" src="<?php  echo $userthumb['justthumb'];?>">
                                <img style="width:300px;" src="<?php  echo $userthumb['backthumb'];?>">
                                <?php  } ?>
                            </li>
                            ...
                            <?php  if($item['status']>=2 && !empty($item['virtual']) ) { ?>
                                ...
                                <li class="text">
                                    ...
                                    <span class="text-default"><?php  echo $user['carrier_address'];?>,<?php  echo $user['carrier_realname'];?>, <?php  echo $user['carrier_mobile'];?></span>
                                </li>
                            <?php  } else { ?>
                                <li class="text">
                            ...
                            <?php  } ?>
                            <?php  if(!empty($storePlan)) { ?>
                            <li class="text">
                                <span class="col-sm">计划核销：</span>
                                <span class="text-default"><?php  echo $storePlan['storename'];?></span>
                            </li>
                            <?php  } ?>
                            <?php  if(!empty($store)) { ?>
                            <li class="text">
                                <span class="col-sm">实际核销：</span>
                                <span class="text-default"><?php  echo $store['storename'];?></span>
                            </li>
                            <?php  } ?>
                             <?php if(cv('order.op.changeStore')) { ?>
                            <div class="col-md-12 ops">
                                <?php  if($item['merchid'] == 0) { ?><a class="btn btn-primary" style="margin-left: 10px" data-toggle="ajaxModal" href="<?php  echo webUrl('order/op/changeStore', array('id' => $item['id']))?>">修改门店信息</a><?php  } ?>
                            </div>
                            <?php  } ?>
            ...
            <div class=" order-container-static">
                ...
                <?php  } ?>
                <?php  if($refund['buyerexpresssn']) { ?>
                    <div class="order-container-footer text col-md-12" style="border: none;padding: 0;margin-top:25px;"><div class="text-primary">买家退货订单号：</div><?php  echo $refund['buyerexpresssn'];?></div>
                <?php  } ?>
            </div>
        ...
        <h3 class="order-title">返利详情</h3>
        <table class="table ">
            <thead>
            <tr class="trorder" style="background: #fff;text-align: center;">
                <th class="" >
                    会员信息
                </th>
                <th>商品信息</th>
                ...
                <th style="padding-left: 20px">备注</th>
            </tr>
            </thead>
            <tbody>

           
            <?php  if(is_array($order_log)) { foreach($order_log as $log) { ?>
                 <tr class="trorder" style="background: #fff;text-align: center;">
                    <td style="border-right: 1px solid #efefef">
                        <a href="<?php  echo webUrl('member/list/detail',array('id' => $log['mid']));?>">
                            <img class="img-40" src="<?php  echo tomedia($log['avatar'])?>" style='border-radius:50%;display: inline;' onerror="this.src='../addons/ewei_shopv2/static/images/noface.png'" />
                           <span style="flex-direction: column;justify-content: center;align-items: flex-start;padding-left: 5px">
                               <span class="nickname">
                                   <?php  if(empty($log['nickname'])) { ?>未更新<?php  } else { ?><?php  echo $log['nickname'];?><?php  } ?>(ID:<?php  echo $log['mid'];?>)
                               </span>
                           </span>
                        </a>
                    </td>
                    <td><?php  echo $log['title'];?><br><?php  echo $log['optionname'];?></td>
                     <td style="">
                        <?php  echo $log['money'];?>
                    </td>
                    <td style="">
                        <?php  if($log['issend']) { ?> 已发放<?php  } else { ?>未发放<?php  } ?>
                    </td>
        ...
        overflow: hidden;text-overflow: ellipsis;"><?php  echo $goods['title'];?></a>
                        ...
                        <?php  if(($goods['cash'])==2) { ?>
                            <label class='label label-danger'>支持货到付款</label>                            
                        <?php  } ?>
                    ...
                    <?php  } ?>
                    <?php  if(!empty($goods['diyformdata']) && $goods['修改收货单信息diyformdata'] != 'false') { ?>
                        <td style="text-align: center;">
            ...
            <tr class="trorder">
                ...
                <td colspan="<?php  echo $colspan;?>" style="padding-right: 60px">
                    <div class="price">
                        ...
                        <?php  if(!empty($item['invoiceprice'])) { ?>
                        <p><span class="price-inner">发票：</span>￥<?php  echo $item['invoiceprice'];?></p>
                        <?php  } ?>
                        <?php  if(!$item['ispackage']) { ?>
                        ...
                        <p><span class="price-inner"><?php  echo $_W['shopset']['trade']['credittext'];?>抵扣：</span><span class="text-danger">-￥<?php  echo $item['deductprice'];?></span></p>
                        <?php  } ?>
                        ...
                        <?php  } ?>
                        <p><span class="price-inner"><?php  if($item['isCash']==1) { ?>应付款：<?php  } else { ?>实付款：<?php  } ?></span><span style="font-size: 14px;font-weight: bold;color: #e4393c">￥<?php  echo $item['price'];?></span></p>
                        <?php  if($item['isCash']==1) { ?>
                        <p><span class="price-inner"><?php  if($item['statusvalue'] > 0) { ?>已付款：<?php  } else { ?>待付款：<?php  } ?></span>￥<?php  echo $item['earnest'];?><?php  if($item['statusvalue']==0) { ?><a style="margin-left: 10px;color:#44abf7;" data-toggle="ajaxModal" href="<?php  echo webUrl('order/op/changefixedmoney', array('earnest' => $item['earnest'],'id' => $item['id'],'goodsid' => $goods['id']))?>">修改</a><?php  } ?>

                        </p>  
                        <p><span class="price-inner">需付款：</span>￥<?php  echo $item['price']-$item['earnest']?></p>  
                        <?php  } ?>
                    </div>
                </td>
            </tr>
