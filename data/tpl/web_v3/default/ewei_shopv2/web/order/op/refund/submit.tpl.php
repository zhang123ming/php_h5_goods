<?php defined('IN_IA') or exit('Access Denied');?><form class="form-horizontal form-validate" action="<?php  echo webUrl('order/op/refund/submit')?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
                        ...
                        <?php  if(($refund['rtype'] == 0 || $refund['rtype'] == 1)) { ?>
                            ...
                            <div class="help-group" style="display: none;">
                                ...
                                <span class="help-block">如有<?php  echo $_W['shopset']['trade']['credittext'];?>抵扣： 会返回<?php  echo $_W['shopset']['trade']['credittext'];?>到商城用户<?php  echo $_W['shopset']['trade']['credittext'];?></span>
