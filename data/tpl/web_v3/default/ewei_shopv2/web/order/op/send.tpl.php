           ...
           <div class="modal-content">
            ...
            <div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" name="expresssn" id="expresssn" class="form-control" value="<?php  echo $item['expresssn'];?>" data-rule-required='true' />
						</div>
					</div>
				<?php  if($order_goods) { ?>
					<div class="form-group">
...
<script language="javascript">
    ...
    $("#express").change(function () {
        ...
        $("#expresscom").val(sel);
        if (obj.val()=='no') {
        	$('#expresssn').attr('disabled',true);
        }else{
        	$('#expresssn').removeAttr('disabled',true);
        }
    });
