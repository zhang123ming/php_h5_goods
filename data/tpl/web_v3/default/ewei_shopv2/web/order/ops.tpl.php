...
<!--快递 发货-->
<?php  if($item['isprepay'] == 1&&!$item['isprepaysuccess']) { ?>
  <?php if(cv('order.op.close')) { ?>
        <a class='btn btn-primary btn-xs'  data-toggle='ajaxModal' href="<?php  echo webUrl('order/op/setbalance',array('id'=>$item['id']))?>" >
            设置尾款
        </a>
    <?php  } ?>
<?php  } else { ?>
