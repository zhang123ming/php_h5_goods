...
<script>$(function(){$('img').attr('onerror', '').on('error', function(){if (!$(this).data('check-src') && (this.src.indexOf('http://') > -1 || this.src.indexOf('https://') > -1)) {this.src = this.src.indexOf('http://www.yesyaodg.com/attachment/') == -1 ? this.src.replace('http://yeshiyiyao.oss-cn-beijing.aliyuncs.com/', 'http://www.yesyaodg.com/attachment/') : this.src.replace('http://www.yesyaodg.com/attachment/', 'http://yeshiyiyao.oss-cn-beijing.aliyuncs.com/');$(this).data('check-src', true);}});});</script></body>
</html>
