                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <?php  if(is_array($perms['parent'])) { foreach($perms['parent'] as $key => $value) { ?>
                            <div class='panel-heading' style='background:#f8f8f8' >
                                <a class="btn btn-link btn-sm pull-right toggle" data-index='<?php  echo $key;?>' data-toggle="collapse"  data-parent="#accordion" href="#collapse<?php  echo $key;?>"><i class='fa fa-angle-down'></i> 展开</a>
...
<script language="javascript">
    $(function () {
        $('.toggle').eq(0).children("i").removeClass('fa fa-angle-down').addClass('fa fa-angle-up');
    ...
    $('.toggle').click(function(){
        if($(this).attr('data-index')=='shop'&&comenumber==1){
            comenumber = 0;
        ...
        if(toggle){
            if(index!=$(this).attr('data-index')){
                ...
                $('.toggle').children("i").removeClass('fa fa-angle-up').addClass('fa fa-angle-down');
