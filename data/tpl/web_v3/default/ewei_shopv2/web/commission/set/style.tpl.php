...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
	<div class="input-group">
	    <div class="input-group-addon">导师</div>
	    <?php if(cv('commission.set.edit')) { ?>
	    	<input type="text" name="texts[commission_superior]" class="form-control" value="<?php echo empty($data['texts']['commission_superior'])?'导师':$data['texts']['commission_superior']?>"  />
	    <?php  } else { ?>
	    	<div class="form-control valid"><?php echo empty($data['texts']['commission_superior'])?'导师':$data['texts']['commission_superior']?></div>
	    <?php  } ?>
	</div>
    </div>
</div>
...
<div class="form-group">
	...
	<div class="input-group">
	    ...
	    <input type="text" name="texts[c4]" class="form-control" value="<?php echo empty($data['texts']['c4'])?'管理':$data['texts']['c4']?>" style="width:100px;" />
	    <?php  } else { ?>
...
<div class="form-group">
    <label class="col-lg control-label">下级分页方式</label>
    <div class="col-sm-8">
			<label class="radio-inline"><input type="radio"  name="data[pageway]" value="0" <?php  if($data['pageway'] ==0) { ?> checked="checked"<?php  } ?> /> 自动分页</label>
			<label class="radio-inline"><input type="radio"  name="data[pageway]" value="1" <?php  if($data['pageway'] ==1) { ?> checked="checked"<?php  } ?> /> 手动分页</label>
    </div>
</div>
<!-- yi fu yuan ma wang -->