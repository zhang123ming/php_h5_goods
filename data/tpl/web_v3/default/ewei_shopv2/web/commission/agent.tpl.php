            ...
            <div class="input-group">
                    ...
                    <div class="input-group-select">
                        <select name='isagentblack'  class='form-control'   style="width:90px;"  >
                          ...
                          <input type="text" class="form-control input-sm"  name="keyword" value="<?php  echo $_GPC['keyword'];?>" placeholder="昵称/姓名/手机号/openid"/>
...
<?php  if(count($list)>0) { ?>
        ...
        <table class="table table-hover table-responsive">
           ...
           <tr >
                ...
                <td>
                    <span class="text-danger"><?php  echo $row['commission_total'];?></span><br/><span class="text-warning"><?php  echo $row['commission_pay'];?></span>
                </td>
                <td >
                ...
                <td>
                    <a href="<?php  echo webUrl('member/list/detail',array('id' => $row['id']));?>" title='查看会员信息' target='_blank' style="display: flex"><?php  echo $row['diyinfo'];?></a>
                </td>
                <td>
                ...
                <td  style="overflow:visible;">
                    ...
                    <?php  } ?>
                    <?php  if($row['level']>0) { ?>
                        <a class="btn  btn-op btn-operation" href="<?php  echo webUrl('commission/agent/performance', array('id'=>$row['id']))?>" target='_blank'>
