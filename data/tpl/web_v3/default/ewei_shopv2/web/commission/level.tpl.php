            ...
            <table class="table table-responsive table-hover">
                ...
                <tbody>
                    ...
                    <tr <?php  if($row['id']=='default') { ?>style='background:#f2f2f2'<?php  } ?>>
                        ...
                        <?php  if($set['level']>=1) { ?>
                        <td><?php  echo number_format((float)$row['commission1'],2)?>%<?php  if(!empty($set['repurchase'])) { ?><br>复购：<?php  echo $row['commission11'];?>%<?php  } ?>
                        </td><?php  } ?>
                         <?php  if($set['level']>=2) { ?><td><?php  echo number_format((float)$row['commission2'],2)?>%<?php  if(!empty($set['repurchase'])) { ?><br>复购：<?php  echo $row['commission22'];?>%<?php  } ?></td><?php  } ?>
                          <?php  if($set['level']>=3) { ?><td><?php  echo number_format((float)$row['commission3'],2)?>%<?php  if(!empty($set['repurchase'])) { ?><br>复购：<?php  echo $row['commission33'];?>%<?php  } ?></td><?php  } ?>
