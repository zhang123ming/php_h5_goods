...
<div class="page-content">
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            <label class="col-lg control-label">是否填写地址</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('creditshop.set.edit')) { ?>
                <label class='radio radio-inline'>
                    <input type='radio' value='0' name='data[set_address]'  <?php  if($data['set_address']==0) { ?>checked<?php  } ?> /> 显示
                </label>
                <label class='radio radio-inline'>
                    <input type='radio' value='1' name='data[set_address]' <?php  if($data['set_address']==1) { ?>checked<?php  } ?> /> 隐藏
                </label>
                <?php  } else { ?>
                <div class='form-control-static'><?php  if($data['set_address']==1) { ?>隐藏<?php  } else { ?>显示<?php  } ?></div>
                <?php  } ?>
            </div>
        </div>
        ...
        <div class='form-group-title'>余额<?php  echo $_W['shopset']['trade']['credittext'];?>设置</div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <div class='input-group fixmore-input-group'>
                    ...
                    <input type="text" name="data[withdrawtext]" class="form-control" value="<?php echo empty($data['withdrawtext'])?'提现手续费':$data['withdrawtext']?>" />
                    <span class='input-group-addon'>其它佣金=</span>
                    <input type="text" name="data[othertext]" class="form-control" value="<?php echo empty($data['othertext'])?'其它佣金':$data['othertext']?>" />
                </div>
                <?php  } else { ?>

                <div class='form-control-static'>
                    <?php  echo $_W['shopset']['trade']['credittext'];?>文字:  <?php echo empty($data['credittext'])?'积分':$data['credittext']?> 余额文字: <?php echo empty($data['moneytext'])?'余额':$data['moneytext']?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <div class='input-group fixmore-input-group'>
                    ...
                    <input type="text" name="data[courier]" class="form-control" value="<?php echo empty($data['courier'])?'快递费':$data['courier']?>" />
                </div>
                <?php  } else { ?>
        ...
        <div class="form-group">
            <label class="col-lg control-label">商品详情自定义文字</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('sysset.trade.edit')) { ?>
                <div class='input-group fixmore-input-group'>
                    <span class='input-group-addon'>快递=</span>
                    <input type="text" name="data[courier2]" class="form-control" value="<?php echo empty($data['courier2'])?'快递':$data['courier2']?>" />
                </div>
                <?php  } ?>
            </div>
        </div>
        <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-lg control-label">账户积分</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('sysset.trade.edit')) { ?>
                <label class='radio-inline'><input type='radio' name='data[closecredit]' value='0' <?php  if(empty($data['closecredit'])) { ?>checked<?php  } ?> /> 开启</label>
                <label class='radio-inline'><input type='radio' name='data[closecredit]' value='1' <?php  if($data['closecredit']=='1') { ?>checked<?php  } ?> /> 关闭</label>
                <span class='help-block'>是否允许用户中心显示账户积分</span>
                <?php  } else { ?>
                <div class='form-control-static'><?php  if($data['closecredit']==1) { ?>关闭<?php  } else { ?>开启<?php  } ?></div>
                <?php  } ?>
            </div>
        </div>

        <div class="form-group">
            <label class="col-lg control-label">账户余额</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('sysset.trade.edit')) { ?>
                <label class='radio-inline'><input type='radio' name='data[closecredit2]' value='0' <?php  if(empty($data['closecredit2'])) { ?>checked<?php  } ?> /> 开启</label>
                <label class='radio-inline'><input type='radio' name='data[closecredit2]' value='1' <?php  if($data['closecredit2']=='1') { ?>checked<?php  } ?> /> 关闭</label>
                <span class='help-block'>是否允许用户中心显示账户余额</span>
                <?php  } else { ?>
                <div class='form-control-static'><?php  if($data['closecredit2']==1) { ?>关闭<?php  } else { ?>开启<?php  } ?></div>
                <?php  } ?>
            </div>
        </div>
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <span class='help-block'>用户充值获得的<?php  echo $_W['shopset']['trade']['credittext'];?>,累计形式 比如 充值1元 送1<?php  echo $_W['shopset']['trade']['credittext'];?>,充值200，就送200<?php  echo $_W['shopset']['trade']['credittext'];?></span>
            <?php  } else { ?>
            ...
            <div class='form-control-static'>
                ...
                充值无<?php  echo $_W['shopset']['trade']['credittext'];?>
                <?php  } else { ?>
                <?php  echo $data['money'];?> 元增加 <?php  echo $data['credit'];?> <?php  echo $_W['shopset']['trade']['credittext'];?>
                <?php  } ?>
            </div>
            <?php  } ?>
        </div>
...
<div class="form-group recharge-group">
    <label class="col-lg control-label">会员<?php  echo $_W['shopset']['trade']['credittext'];?>上限</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('sysset.trade.edit')) { ?>
        <div class="input-group fixsingle-input-group">
            <input type="number" name="data[maxcredit]" class="form-control" value="<?php  echo intval($data['maxcredit'])?>" />
            <div class="input-group-addon"><?php  echo $_W['shopset']['trade']['credittext'];?></div>
        </div>
        <span class='help-block text-danger'>会员最高<?php  echo $_W['shopset']['trade']['credittext'];?>，0为不限制(会员<?php  echo $_W['shopset']['trade']['credittext'];?>大于等于此值时将无法继续增加，后台手动充值不限制，已持有<?php  echo $_W['shopset']['trade']['credittext'];?>不限制)</span>
        <?php  } else { ?>
        <input type="hidden" name="data[maxcredit]" value="<?php  echo $data['maxcredit'];?>"/>
        <div class='form-control-static'>
            <?php  echo $data['maxcredit'];?><?php  echo $_W['shopset']['trade']['credittext'];?>
        </div>
        <?php  } ?>
    </div>
</div>
...
<div class='form-group-title'>商城收款账户</div>
...
<div class='panel-body'>
    ...
    <div class="form-group">
       <label class="col-lg control-label">收款账户姓名 </label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.trade.edit')) { ?>
            <input type="text" name="data[collect_name]" class="form-control" value="<?php  echo $data['collect_name'];?>" />
            <?php  } else { ?>
    ...
    <div class="form-group">
        <label class="col-lg control-label">收款账户银行卡号 </label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.trade.edit')) { ?>
            <input type="text" name="data[collect_account]" class="form-control" value="<?php  echo $data['collect_account'];?>" />
            <?php  } else { ?>
            <input type="hidden" name="data[shareaddress]" value="<?php  echo $data['shareaddress'];?>"/>
            <div class='form-control-static'><?php  if($data['shareaddress']==1) { ?>开启<?php  } else { ?>关闭<?php  } ?></div>
            <?php  } ?>
    ...
    <div class="form-group">
        <label class="col-lg control-label">收款账户支行名称 </label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.trade.edit')) { ?>
            <input type="text" name="data[collect_address]" class="form-control" value="<?php  echo $data['collect_address'];?>" />
            <?php  } else { ?>
            <input type="hidden" name="data[shareaddress]" value="<?php  echo $data['shareaddress'];?>"/>
            <div class='form-control-static'><?php  if($data['shareaddress']==1) { ?>开启<?php  } else { ?>关闭<?php  } ?></div>
            <?php  } ?>
