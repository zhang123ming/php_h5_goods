    ...
    <div class="page-content">
        ...
        <div class=" sms-aliyun" style="<?php  if(empty($item['aliyun'])) { ?>display: none;<?php  } ?>">
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="aliyun_appkey" class="form-control valid" value="<?php  echo $item['aliyun_appkey'];?>" data-rule-required="true">
                </div>
                <label class="col-sm-2 control-label must">AppSecret</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="aliyun_appsecret" class="form-control valid" value="<?php  echo $item['aliyun_appsecret'];?>" data-rule-required="true">
                </div>
            </div>
        </div>
