...
<form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="tabs-container">
                    ...
                    <div class="tabs">
                        <ul class="nav nav-tabs">
                            ...
                            <li <?php  if($type=='credit1') { ?>class="active"<?php  } ?>><a data-toggle="tab" href="#tab-1" data-rechargetype="credit1" aria-expanded="true"> 充值<?php  echo $_W['shopset']['trade']['credittext'];?></a></li>
                            <?php  } ?>
                        ...
                        <div class="tab-content ">
                            <div id="tab-1" class="tab-pane <?php  if($type=='credit1') { ?>active<?php  } ?>">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">当前<?php  echo $_W['shopset']['trade']['credittext'];?></label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <label class='radio-inline'>
                            <input type='radio' name='changetype' value='2' /> 最终<span class='name'><?php  if($type=='credit1') { ?><?php  echo $_W['shopset']['trade']['credittext'];?><?php  } else { ?>余额<?php  } ?></span>
                        </label>
                    </div>
                </div>
            ...
            <button class="btn btn-primary btn-submit" type="submit">确认充值<?php  if($type=='credit1') { ?><?php  echo $_W['shopset']['trade']['credittext'];?><?php  } else { ?>余额<?php  } ?></button>
...
<script language='javascript'>
    $(function(){
        $('[data-toggle="tab"]').click(function(){
            ...
            if(type=='credit1') {
                $('.name').html('<?php  echo $_W['shopset']['trade']['credittext'];?>');
                $(".btn-submit").text('确认充值<?php  echo $_W['shopset']['trade']['credittext'];?>');
            }else{
                $('.name').html('余额');
