...
<div class="page-content">
    <form action="./index.php" method="get" class="form-horizontal table-search" role="form" id="form1">
        ...
        <div class="page-toolbar" style="height: 90px;">
            ...
            <div class="input-group" >
                ...
                <span class="input-group-select">
                    <?php  if($_GPC['type']==0) { ?>
                    <select name="rechargetype" class="form-control" style="width:150px;"  >
                ...
                <input class="form-control" type="text" name="rechargemoney[min]" style="width:150px;"  value="<?php  echo $_GPC['rechargemoney']['min'];?>" placeholder="请输入充值金额" />
                <span class="form-control" style="width:20px;">-</span>
                <input class="form-control" type="text" name="rechargemoney[max]" style="width:150px;"  value="<?php  echo $_GPC['rechargemoney']['max'];?>" placeholder="请输入充值金额"/>
