...
<div class="js-profile-payment" ng-controller="paymentCtrl" ng-cloak>
	<table class="table we7-table table-hover table-form">
		...
		<tr>
			...
			<td>
				<label>
					<input name="" class="form-control" type="checkbox"  style="display: none;" ng-click="saveEdit('mix')">
					<div ng-class="paysetting.mix.switch === true ? 'switch switchOn' : 'switch'"></div>
				</label>
			</td>
			<td></td>
		</tr>
		...
		<tr>
			...
			<td>
				{{  paysetting.qukuailian.switch === true ? '开启' : '关闭'  }}
			</td>
			<td class="text-center">
				<div class="link-group"><a href="javascript:;" class="color-default" data-toggle="modal" data-target="#wechat_qukuailian">修改</a></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td >
				{{  paysetting.jueqiymf.switch === true ? '开启' : '关闭'  }}
			</td>
			<td class="text-center">
				<div class="link-group"><a href="javascript:;" data-toggle="modal" data-target="#jueqiymf">修改</a></div>
			</td>
		</tr>
		<tr>
			<td>
	...
	<!-- 区块链支付 -->
	<div class="modal fade" id="wechat_qukuailian" tabindex="-1" role="dialog" aria-hidden="true">
		<form action="<?php  echo url('profile/payment/save_setting', array('type' => 'qukuailian'))?>" enctype="multipart/form-data" method="post" id="form1" >
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
					<div class="modal-title">区块链支付</div>
				</div>
				<div class="modal-body">
					<div class="we7-form">
						<div class="form-group">
							<label for="" class="control-label col-sm-2">区块链支付</label>
								<div class="form-controls col-sm-10">
									<input id='radio-1592' type="radio" name='qukuailian[switch]' <?php  if($pay_setting['qukuailian']['switch'] == true) { ?>checked<?php  } ?> value="true"/>
									<label for="radio-1592">开启 </label>
									<input id='radio-1593' type="radio" name='qukuailian[switch]' <?php  if($pay_setting['qukuailian']['switch'] == false) { ?>checked<?php  } ?> value="false"/>
									<label for="radio-1593">关闭 </label>
									<span class="help-block">是否使用区块链支付</span>
								</div>
						</div>
						<div class="form-group">
							<label for="" class="control-label col-sm-2">未来链商户号</label>
							<div class="form-controls col-sm-10">
								<input name="qukuailian[merid]" value="<?php  echo $pay_setting['qukuailian']['merid'];?>"  class="form-control" placeholder="" >
								<span class="help-block">需要填写申请为区块链的商户号。</span>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="control-label col-sm-2">商户支付密钥</label>
							<div class="form-controls col-sm-10">
								<!-- <input type="text" name="qukuailian[signkey]" value="<?php  echo $pay_setting['qukuailian']['signkey'];?>"  class="form-control" placeholder=""> -->
								<textarea style="height:80px;" name="qukuailian[signkey]" cols="65"></textarea>
								<span class="help-block">此商户秘钥为区块链商户号对应的支付公钥。</span>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="we7-form">
						<div class="form-group">
							<label for="" class="control-label col-sm-2">一码付</label>
							<div class="form-controls col-sm-10">
								<input id='radio-1225' type="radio" name='paysetting[jueqiymf][switch]' ng-checked='paysetting.jueqiymf.switch === true' ng-click="changeSwitch('jueqiymf', true)"/>
								<label for="radio-1225">开启 </label>
								<input id='radio-21216' type="radio" name='paysetting[jueqiymf][switch]'  ng-checked='paysetting.jueqiymf.switch === false' ng-click="changeSwitch('jueqiymf', false)" />
								<label for="radio-21216">关闭 </label>
							</div>
						</div>
						<div class="form-group">
