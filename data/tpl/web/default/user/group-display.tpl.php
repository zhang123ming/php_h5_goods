...
<table class="table we7-table table-hover" id="js-user-group-display" ng-controller="UserGroupDisplay" ng-cloak>
	...
	<tr ng-repeat="list in lists">
		...
		<td><span ng-if="list.maxwebapp == 0">无权限</span><span ng-if="list.maxwebapp != 0" ng-bind="list.maxwebapp"></span></td>
		<td>
		...
		<td>
			<span ng-if="list.webapp_nums == -1">全部</span>
			<span ng-if="list.webapp_nums != -1" ng-bind="list.webapp_nums"></span>
		</td>
		<td>
