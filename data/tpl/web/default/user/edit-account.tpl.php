...
<div id="js-user-edit-account" ng-controller="UserEditAccount" ng-cloak>
	...
	<table class="table we7-table table-hover">
		...
		<tr ng-repeat="webapp in webapps" ng-if="webapps">
			...
			<td>
				<div class="link-group">
					<a ng-href="./index.php?c=account&a=post&do=base&uniacid={{webapp.uniacid}}&acid={{webapp.acid}}&account_type=<?php echo ACCOUNT_TYPE_WEBAPP_NORMAL;?>" class="color-default">PC设置</a>
					<a ng-href="./index.php?c=account&a=post-user&do=edit&uniacid={{webapp.uniacid}}&acid={{webapp.acid}}&account_type=<?php echo ACCOUNT_TYPE_WEBAPP_NORMAL;?>" class="color-default">操作员设置</a>
				</div>
			</td>
		</tr>
		<tr ng-if="!webapps">
