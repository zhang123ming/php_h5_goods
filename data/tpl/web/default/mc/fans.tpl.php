...
<div class="we7-page-search we7-padding-bottom clearfix">
	...
	<form action="" method="post" class="form-inline" role="form">
		...
		<div class="form-group">
			<div class="form-controls">
				<select name="lasttime" class="we7-select" >
					<option value="" <?php  if(!$lasttime) { ?>selected<?php  } ?>>活跃时间</option>
					<option value="1" <?php  if($lasttime == 1) { ?>selected<?php  } ?>>48小时内</option>
					<option value="2" <?php  if($lasttime == 2) { ?>selected<?php  } ?>>48小时外</option>
				</select>
			</div>
		</div>
				...
				<table class="table we7-table table-hover fans-info vertical-middle">
					...
					<tr>
						...
						<td class="text-right">
							...
							<?php  } else { ?>
							<?php  if($fan['lasttime']&&$lasttime) { ?>
								<p>活跃：<?php  echo date('Y-m-d H:i:s', $fan['lasttime'])?></p>
							<?php  } else { ?>
