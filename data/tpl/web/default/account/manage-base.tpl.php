...
<div id="js-account-manage-base" ng-controller="AccountManageBase" ng-cloak>
	...
	<table class="table we7-table table-hover table-form">
		...
		<tr>
			<td class="table-label">账号类型</td>
			<td ng-if="account.istest == 0">正式账号</td>
			<td ng-if="account.istest == 1">测试账号</td>
			<td >
				<?php  if($_W['isfounder']) { ?>
				<div class="link-group">
					<a href="javascript:;" data-toggle="modal" data-target="#istest" ng-click="editInfo('istest', account.istest)">修改</a>
				</div>
				<?php  } ?>
			</td>
		</tr>
		<tr ng-show="account.istest == 1">
			<td class="table-label">测试时间</td>
			<td><span ng-bind="account.testtime"></span><span class="color-gray">（显示于测试账号的提示）</span></td>
			<td>
				<div class="link-group" ng-if="founder || owner">
					<a href="javascript:;" data-toggle="modal" data-target="#testtime" ng-click="editInfo('testtime', account.testtime)">修改</a>
				</div>
			</td>
		</tr>
		<tr>
	...
	<div class="modal fade" id="testtime" role="dialog">
		<div class="we7-modal-dialog modal-dialog we7-form">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				...
				<div class="modal-body">
					<div class="form-group">
						<?php  echo tpl_form_field_date('testtime', $account['testtime']);?>
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" data-dismiss="modal" ng-click="httpChange('testtime')">确定</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				</div>
			</div>
		</div>
	...
	<div class="modal fade" id="istest" role="dialog">
		<div class="we7-modal-dialog modal-dialog we7-form">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				...
				<div class="modal-body text-center">
					<input id="istest-1" type="radio" name="istest" value="0" ng-model="middleAccount.istest" ng-checked="middleAccount.istest == '0'">
					<label class="radio-inline" for="istest-1">正式帐户</label>
					<input id="istest-2" type="radio" name="istest" value="1" ng-model="middleAccount.istest" ng-checked="middleAccount.istest == '1'">
					<label class="radio-inline" for="istest-2">测试帐户</label>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" data-dismiss="modal" ng-click="httpChange('istest')">确定</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				</div>
			</div>
		</div>
