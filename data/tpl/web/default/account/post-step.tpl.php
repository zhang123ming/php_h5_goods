...
<?php  } else if($_GPC['step'] == 2) { ?>
	<div class="account-list-add-step">
		...
		<form action="" method="post" class="we7-form" enctype="multipart/form-data" id="js-account-post-step2" ng-controller="AccountPostStepTwo" ng-cloak>
			...
			<div class="form-group">
				<label for="" class="control-label col-sm-2">账号类型</label>
				<div class="form-controls col-sm-8">
					<select name="istest" class="we7-select">
						<option value="1" ng-selected="account.istest == 1">测试账号</option>
						<option value="0" ng-selected="account.istest == 0">正式账号</option>
					</select>
				</div>
			</div>
			<div class="form-group">
