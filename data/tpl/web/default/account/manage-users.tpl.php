	...
	<table class="table we7-table table-hover">
		...
		<tr>
			...
			<th class="text-right">
				...
				<?php  if(permission_check_account_user('see_account_manage_users_add_viceuser')) { ?><span class="btn btn-link color-default" data-toggle="modal" data-target="#user-vice-modal">添加副创始人</span><?php  } ?>
		...
		<tr ng-repeat="permission in permissions" ng-if="permission.uid">
			...
			<td  class="we7-padding-right text-right">
				<div class="link-group">
					...
					<?php  if(permission_check_account_user('see_account_manage_users_edit')) { ?><a href="javascript:;" ng-if="permission.role == 'vice_founder' && permission.isfounder == 0" ng-click="changeVice(permission.username)">修改</a><?php  } ?>
