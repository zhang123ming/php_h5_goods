				...
				<?php  if(!in_array($section_id, array('platform_module'))) { ?>
					...
					<tr class="text-left">
						<th colspan="4" class="text-left">
							<div class="">
								<!-- <input id="check-<?php  echo $section_id;?>" type="checkbox"  we7-check-all="1" name="system_<?php  echo $section_id;?>" onChange="selectall(this, 'system_<?php  echo $section_id;?>')"> -->
			...
			<tr>
				<th colspan="4" class="text-left">
					<div class="">
						...
						<label class=" we7-margin-horizontal-none">应用权限</label>
					</div>
				</th>
			</tr>
		</thead>
