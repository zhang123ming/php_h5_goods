...
<form action="" method="post" class="panel panel-cut" id="js-wesite-post" ng-controller="WesitePost" ng-cloak>
	...
	<div class="panel-body">
		<div class="site-select-tem">
			<div class="select-tem-heading">选择模板</div>
			...
			<div class="select-tem-list">
				<ul>
					<li class="select-tem-item" ng-repeat="style in styles" ng-class="{'active': multi.style.id == style.id}" ng-click="selectStyle(style)" ng-show="temtype.name == 'all' || temtype.name == style.type">
						...
						<img ng-src="../app/themes/{{style.tname}}/preview.jpg" onerror="this.src='http://we7cloud-10016060.file.myqcloud.com/images/2016/11/17/1479364010582d4daaccd11_NHbS9qcx14Sc.jpg'" />
		...
		<div class="site-view">
			<div class="we7-iphone-view">
				<div ng-style="{'background': 'url(./resource/images/new/iphone6.png) no-repeat 9px 0px', 'margin-top': '-30px'}">
					<iframe ng-src="{{siteEntrance}}" frameborder="0" width="320" height="568" scrolling="no" id="preview-iframe" ng-style="{'transform': 'scale(0.7)', 'margin-left': '-10px', 'margin-top': '-44px'}"></iframe>
					<span class="btn btn-primary" ng-style="{'margin-left': '36%'}" onclick="document.getElementById('preview-iframe').contentWindow.location.reload(true);">预览刷新</span>
					<div class="help-block">
						<span class="color-red">温馨提示：</span>
						预览刷新功能只支持幻灯片、导航菜单、底部菜单功能。其他请点击"完成"按钮再行查看！
					</div>
				</div>
		...
		<div class="site-edit-view">
			...
			<div class="tab-content site-edit-content">
				<!--入口-->
				<div class="we7-form tab-pane active" id="entrance">
					<div class="site-edit-heading">
						微官网入口
					</div>
					<div class="entrance-url site-edit-heading">
						<div class="form-group">
				...
				<div class="tab-pane fade" id="slide">
					...
					<div class="site-slide-list">
						<div class="site-edit-heading">幻灯片</div>
						<ul>
				...
				<div class="tab-pane fade homemenu" id="homemenu">
					<div class="site-edit-heading">首页导航菜单</div>
					...
					<div class="site-nav-edit" ng-show="addHomemenuStatus">
						...
						<div class="we7-form">
							...
							<div class="btn btn-primary we7-padding-horizontal site-btn-bottom" ng-click="saveMenu()">保存</div>
						</div>
					</div>
				</div>
				...
				<div class="tab-pane fade shopNav" id="quickmenu">
					<div class="site-edit-heading">导航快捷菜单</div>
					<div class="we7-form app-side">
						...
						<div class="btn btn-primary we7-padding-horizontal site-btn-bottom" ng-click="saveQucikMenu()">保存</div>
					</div>
				</div>
			</div>
		</div>
